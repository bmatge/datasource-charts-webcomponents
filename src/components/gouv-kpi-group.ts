...
/**
 * <gouv-kpi-group> - Groupe de KPIs en grille responsive
 *
 * Dispose plusieurs <gouv-kpi> enfants dans une grille CSS 12 colonnes.
 * Chaque KPI peut specifier sa largeur via l'attribut `col` (1-12).
 *
 * @example
 * <gouv-kpi-group cols="3">
 *   <gouv-kpi source="src" valeur="sum:population" label="Population"></gouv-kpi>
 *   <gouv-kpi source="src" valeur="avg:score" label="Score moyen"></gouv-kpi>
 *   <gouv-kpi source="src" valeur="count" label="Nombre"></gouv-kpi>
 * </gouv-kpi-group>
 *
 * @example
 * <gouv-kpi-group>
 *   <gouv-kpi source="src" valeur="sum:ca" label="CA total" col="6"></gouv-kpi>
 *   <gouv-kpi source="src" valeur="avg:marge" label="Marge" col="3"></gouv-kpi>
 *   <gouv-kpi source="src" valeur="count" label="Transactions" col="3"></gouv-kpi>
 * </gouv-kpi-group>
 */
@customElement('gouv-kpi-group')
export class GouvKpiGroup extends LitElement {
  ...
  connectedCallback() {
    ...
    sendWidgetBeacon('gouv-kpi-group');
