 ...
 * </app-layout-demo>
 */
let AppLayoutDemo = class AppLayoutDemo extends LitElement {
    constructor() {
        super(...arguments);
        /**
...
], AppLayoutDemo.prototype, "title", void 0);
__decorate([
    property({ type: String })
], AppLayoutDemo.prototype, "icon", void 0);
__decorate([
    property({ type: String, attribute: 'active-path' })
], AppLayoutDemo.prototype, "activePath", void 0);
__decorate([
    property({ type: String, attribute: 'base-path' })
], AppLayoutDemo.prototype, "basePath", void 0);
AppLayoutDemo = __decorate([
