...
/**
 * <gouv-world-map> - Carte du monde choropleth avec zoom continent
 *
 ...
 * </gouv-world-map>
 */
@customElement('gouv-world-map')
export class GouvWorldMap extends SourceSubscriberMixin(LitElement) {
  ...
  connectedCallback() {
    ...
    sendWidgetBeacon('gouv-world-map');
    this._loadMap();
  }
