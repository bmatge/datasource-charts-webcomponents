...
// Since GouvSource is a LitElement with decorators, we test the underlying
// logic through the adapter params construction and public methods

describe('GouvSource adapter mode detection', () => {
...
describe('GouvSource getEffectiveWhere logic', () => {
...
describe('GouvSource adapter params construction', () => {
...
describe('GouvSource command handling', () => {
