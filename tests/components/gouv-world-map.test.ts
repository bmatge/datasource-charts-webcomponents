...
import { GouvWorldMap } from '../../src/components/gouv-world-map.js';
...
/**
 * Helper: create a GouvWorldMap instance with sensible defaults.
 * We access private members via (instance as any).
 */
function createInstance(overrides: Partial<GouvWorldMap> = {}): GouvWorldMap {
  const el = new GouvWorldMap();
  Object.assign(el, overrides);
  return el;
}

describe('GouvWorldMap', () => {
  ...
  describe('with mock topology', () => {
    function createWithTopology(overrides: Partial<GouvWorldMap> = {}): GouvWorldMap {
