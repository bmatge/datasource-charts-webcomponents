...
\f\r]`,Se=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Tt=/-->/g,Ot=/>/g,H=RegExp(`>|${Ve}(?:([^\\s"'>=/]+)(${Ve}*=${Ve}*(?:[^ 	
...
${r}
    ...
    `}},d(pe,"AppHeader"),pe),xe([h({type:String,attribute:"current-page"})],l.AppHeader.prototype,"currentPage",void 0),xe([h({type:String,attribute:"base-path"})],l.AppHeader.prototype,"basePath",void 0),xe([b()],l.AppHeader.prototype,"_favCount",void 0),l.AppHeader=xe([k("app-header")],l.AppHeader);var Xt=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.AppFooter=(fe=class extends C{constructor(){super(...arguments),this.basePath=""}get _base(){const e=this.basePath;return e?e.endsWith("/")?e:e+"/":""}createRenderRoot(){return this}render(){return p`
