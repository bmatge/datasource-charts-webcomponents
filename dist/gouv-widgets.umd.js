...
`),s=new Blob([n],{type:"text/csv;charset=utf-8;"}),l=URL.createObjectURL(s),c=document.createElement("a");c.href=l,c.download="export.csv",c.click(),URL.revokeObjectURL(l)}formatCellValue(e){return e==null?"—":typeof e=="boolean"?e?"Oui":"Non":String(e)}_renderFilters(e,t){return t.length===0?"":h`
    ...
    `}},u(J,"AppHeader"),J),me([d({type:String,attribute:"current-page"})],o.AppHeader.prototype,"currentPage",void 0),me([d({type:String,attribute:"base-path"})],o.AppHeader.prototype,"basePath",void 0),me([y()],o.AppHeader.prototype,"_favCount",void 0),o.AppHeader=me([C("app-header")],o.AppHeader);var _t=function(a,e,t,r){var i=arguments.length,n=i<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(s=a[l])&&(n=(i<3?s(n):i>3?s(e,t,n):s(e,t))||n);return i>3&&n&&Object.defineProperty(e,t,n),n};o.AppFooter=(X=class extends ${constructor(){super(...arguments),this.basePath=""}get _base(){const e=this.basePath;return e?e.endsWith("/")?e:e+"/":""}createRenderRoot(){return this}render(){return h`
