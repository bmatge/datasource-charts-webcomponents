 ...
 */function m(n){return u({...n,state:!0,attribute:!1})}h(m,"r");function b(n,e){if(!e||e.trim()==="")return n;const i=e.replace(/\[(\d+)\]/g,".$1").split(".");let r=n;for(const s of i){if(r==null||typeof r!="object")return;r=r[s]}return r}h(b,"getByPath");function li(n,e){return b(n,e)!==void 0}h(li,"hasPath");function Et(n,e,t){const r=e.replace(/\[(\d+)\]/g,".$1").split(".");let s=n;for(let a=0;a<r.length-1;a++){const o=r[a];(!(o in s)||typeof s[o]!="object"||s[o]===null)&&(s[o]={}),s=s[o]}s[r[r.length-1]]=t}h(Et,"setByPath");function ci(n,e,t){const i=b(n,e);return i!==void 0?i:t}h(ci,"getByPathOrDefault");const ui="https://chartsbuilder.matge.com/beacon",Rt=new Set;function x(n,e){const t=`${n}:${e||""}`;if(Rt.has(t)||(Rt.add(t),typeof window>"u"))return;const i=window.location.hostname;if(i==="localhost"||i==="127.0.0.1"||i==="chartsbuilder.matge.com")return;const r=new URLSearchParams;r.set("c",n),e&&r.set("t",e);const s=`${ui}?${r.toString()}`;try{fetch(s,{method:"GET",keepalive:!0,mode:"no-cors"}).catch(()=>{})}catch{}}h(x,"sendWidgetBeacon");function Qe(n){return n?String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}h(Qe,"escapeHtml");function Gt(n,e=!1){if(typeof n=="number")return isNaN(n)?e?null:0:n;if(typeof n!="string")return e?null:0;let t=n.trim();if(t==="")return e?null:0;t=t.replace(/\s/g,"");const i=t.includes(","),r=t.includes(".");if(i&&r){const a=t.lastIndexOf(","),o=t.lastIndexOf(".");a>o?t=t.replace(/\./g,"").replace(",","."):t=t.replace(/,/g,"")}else i&&(t=t.replace(",","."));const s=parseFloat(t);return isNaN(s)?e?null:0:s}h(Gt,"toNumber");function hi(n){if(typeof n!="string")return!1;const e=n.trim();return e===""?!1:/^-?[\d\s]+([.,]\d+)?$/.test(e)}h(hi,"looksLikeNumber");function di(n){return!n||typeof n!="string"||["N/A","null","undefined","00",""].includes(n)?!1:!!(n==="2A"||n==="2B"||/^97[1-6]$/.test(n)||/^(0[1-9]|[1-8]\d|9[0-5])$/.test(n))}h(di,"isValidDeptCode");const We={baseUrl:"https://chartsbuilder.matge.com",endpoints:{grist:"/grist-proxy",gristGouv:"/grist-gouv-proxy",albert:"/albert-proxy",tabular:"/tabular-proxy"}};function pi(){return typeof window<"u"&&window.location.hostname==="localhost"&&window.location.port==="5173"}h(pi,"isViteDevMode");function fi(){return typeof window<"u"&&"__TAURI__"in window}h(fi,"isTauriMode");function Ft(){var i;const n={...We.endpoints};return pi()?{baseUrl:"",endpoints:n}:fi()?{baseUrl:We.baseUrl,endpoints:n}:{baseUrl:((i={url:typeof document>"u"&&typeof location>"u"?require("url").pathToFileURL(__filename).href:typeof document>"u"?location.href:M&&M.tagName.toUpperCase()==="SCRIPT"&&M.src||new URL("gouv-widgets.umd.js",document.baseURI).href}.env)==null?void 0:i.VITE_PROXY_URL)||We.baseUrl,endpoints:n}}h(Ft,"getProxyConfig");function gi(n){const e=Ft();return n.includes("tabular-api.data.gouv.fr")?n.replace("https://tabular-api.data.gouv.fr",`${e.baseUrl}${e.endpoints.tabular}`):n.includes("docs.getgrist.com")?n.replace("https://docs.getgrist.com",`${e.baseUrl}${e.endpoints.grist}`):n.includes("grist.numerique.gouv.fr")?n.replace("https://grist.numerique.gouv.fr",`${e.baseUrl}${e.endpoints.gristGouv}`):n.includes("albert.api.etalab.gouv.fr")?n.replace("https://albert.api.etalab.gouv.fr",`${e.baseUrl}${e.endpoints.albert}`):n}h(gi,"getProxiedUrl");const k={LOADED:"gouv-data-loaded",ERROR:"gouv-data-error",LOADING:"gouv-data-loading",PAGE_REQUEST:"gouv-page-request"},Ke=new Map,Je=new Map;function _i(n,e){Ke.set(n,e)}h(_i,"setDataCache");function V(n){return Ke.get(n)}h(V,"getDataCache");function Se(n){Ke.delete(n)}h(Se,"clearDataCache");function Mt(n,e){Je.set(n,e)}h(Mt,"setDataMeta");function Xe(n){return Je.get(n)}h(Xe,"getDataMeta");function xt(n){Je.delete(n)}h(xt,"clearDataMeta");function z(n,e){_i(n,e);const t=new CustomEvent(k.LOADED,{bubbles:!0,composed:!0,detail:{sourceId:n,data:e}});document.dispatchEvent(t)}h(z,"dispatchDataLoaded");function T(n,e){const t=new CustomEvent(k.ERROR,{bubbles:!0,composed:!0,detail:{sourceId:n,error:e}});document.dispatchEvent(t)}h(T,"dispatchDataError");function L(n){const e=new CustomEvent(k.LOADING,{bubbles:!0,composed:!0,detail:{sourceId:n}});document.dispatchEvent(e)}h(L,"dispatchDataLoading");function Ze(n,e){const t=new CustomEvent(k.PAGE_REQUEST,{bubbles:!0,composed:!0,detail:{sourceId:n,page:e}});document.dispatchEvent(t)}h(Ze,"dispatchPageRequest");function Tt(n,e){const t=h(i=>{const r=i;r.detail.sourceId===n&&e(r.detail.page)},"handler");return document.addEventListener(k.PAGE_REQUEST,t),()=>document.removeEventListener(k.PAGE_REQUEST,t)}h(Tt,"subscribeToPageRequests");function X(n,e){const t=h(s=>{const a=s;a.detail.sourceId===n&&e.onLoaded&&e.onLoaded(a.detail.data)},"handleLoaded"),i=h(s=>{const a=s;a.detail.sourceId===n&&e.onError&&e.onError(a.detail.error)},"handleError"),r=h(s=>{s.detail.sourceId===n&&e.onLoading&&e.onLoading()},"handleLoading");return document.addEventListener(k.LOADED,t),document.addEventListener(k.ERROR,i),document.addEventListener(k.LOADING,r),()=>{document.removeEventListener(k.LOADED,t),document.removeEventListener(k.ERROR,i),document.removeEventListener(k.LOADING,r)}}h(X,"subscribeToSource");var E=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.GouvSource=(te=class extends ${constructor(){super(...arguments),this.url="",this.method="GET",this.headers="",this.params="",this.refresh=0,this.transform="",this.paginate=!1,this.pageSize=20,this._loading=!1,this._error=null,this._data=null,this._currentPage=1,this._refreshInterval=null,this._abortController=null,this._unsubscribePageRequests=null}createRenderRoot(){return this}render(){return p``}connectedCallback(){super.connectedCallback(),x("gouv-source"),this._setupRefresh(),this._setupPageRequestListener()}disconnectedCallback(){super.disconnectedCallback(),this._cleanup(),this.id&&(Se(this.id),xt(this.id))}updated(e){(e.has("url")||e.has("params")||e.has("transform"))&&(this.paginate&&(e.has("url")||e.has("params"))&&(this._currentPage=1),this._fetchData()),e.has("refresh")&&this._setupRefresh(),(e.has("paginate")||e.has("pageSize"))&&this._setupPageRequestListener()}_cleanup(){this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=null),this._abortController&&(this._abortController.abort(),this._abortController=null),this._unsubscribePageRequests&&(this._unsubscribePageRequests(),this._unsubscribePageRequests=null)}_setupRefresh(){this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=null),this.refresh>0&&(this._refreshInterval=window.setInterval(()=>{this._fetchData()},this.refresh*1e3))}async _fetchData(){if(this.url){if(!this.id){console.warn('gouv-source: attribut "id" requis pour identifier la source');return}this._abortController&&this._abortController.abort(),this._abortController=new AbortController,this._loading=!0,this._error=null,L(this.id);try{const e=gi(this._buildUrl()),t=this._buildFetchOptions(),i=await fetch(e,{...t,signal:this._abortController.signal});if(!i.ok)throw new Error(`HTTP ${i.status}: ${i.statusText}`);const r=await i.json();this.paginate&&r.meta&&Mt(this.id,{page:r.meta.page??this._currentPage,pageSize:r.meta.page_size??this.pageSize,total:r.meta.total??0}),this.transform?this._data=b(r,this.transform):this.paginate&&r.data&&!this.transform?this._data=r.data:this._data=r,z(this.id,this._data)}catch(e){if(e.name==="AbortError")return;this._error=e,T(this.id,this._error),console.error(`gouv-source[${this.id}]: Erreur de chargement`,e)}finally{this._loading=!1}}}_buildUrl(){const e=window.location.origin!=="null"?window.location.origin:void 0,t=new URL(this.url,e);if(this.params&&this.method==="GET")try{const i=JSON.parse(this.params);Object.entries(i).forEach(([r,s])=>{t.searchParams.set(r,String(s))})}catch(i){console.warn("gouv-source: params invalides (JSON attendu)",i)}return this.paginate&&(t.searchParams.set("page",String(this._currentPage)),t.searchParams.set("page_size",String(this.pageSize))),t.toString()}_buildFetchOptions(){const e={method:this.method};if(this.headers)try{e.headers=JSON.parse(this.headers)}catch(t){console.warn("gouv-source: headers invalides (JSON attendu)",t)}return this.method==="POST"&&this.params&&(e.headers={"Content-Type":"application/json",...e.headers||{}},e.body=this.params),e}_setupPageRequestListener(){this._unsubscribePageRequests&&(this._unsubscribePageRequests(),this._unsubscribePageRequests=null),this.paginate&&this.id&&(this._unsubscribePageRequests=Tt(this.id,e=>{e!==this._currentPage&&(this._currentPage=e,this._fetchData())}))}reload(){this._fetchData()}getData(){return this._data}isLoading(){return this._loading}getError(){return this._error}},h(te,"GouvSource"),te),E([u({type:String})],l.GouvSource.prototype,"url",void 0),E([u({type:String})],l.GouvSource.prototype,"method",void 0),E([u({type:String})],l.GouvSource.prototype,"headers",void 0),E([u({type:String})],l.GouvSource.prototype,"params",void 0),E([u({type:Number})],l.GouvSource.prototype,"refresh",void 0),E([u({type:String})],l.GouvSource.prototype,"transform",void 0),E([u({type:Boolean})],l.GouvSource.prototype,"paginate",void 0),E([u({type:Number,attribute:"page-size"})],l.GouvSource.prototype,"pageSize",void 0),E([m()],l.GouvSource.prototype,"_loading",void 0),E([m()],l.GouvSource.prototype,"_error",void 0),E([m()],l.GouvSource.prototype,"_data",void 0),l.GouvSource=E([A("gouv-source")],l.GouvSource);var w=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};const Ee=100,Ye=10,Re=100,et=500;l.GouvQuery=(ie=class extends ${constructor(){super(...arguments),this.apiType="generic",this.source="",this.baseUrl="",this.datasetId="",this.resource="",this.select="",this.where="",this.filter="",this.groupBy="",this.aggregate="",this.orderBy="",this.limit=0,this.transform="",this.refresh=0,this._loading=!1,this._error=null,this._data=[],this._rawData=[],this._refreshInterval=null,this._abortController=null,this._unsubscribe=null}createRenderRoot(){return this}render(){return p``}connectedCallback(){super.connectedCallback(),x("gouv-query",this.apiType),this._initialize()}disconnectedCallback(){super.disconnectedCallback(),this._cleanup(),this.id&&Se(this.id)}updated(e){["source","apiType","baseUrl","dataset","resource","select","where","filter","groupBy","aggregate","orderBy","limit","transform"].some(i=>e.has(i))&&this._initialize(),e.has("refresh")&&this._setupRefresh()}_cleanup(){this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=null),this._abortController&&(this._abortController.abort(),this._abortController=null),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=null)}_setupRefresh(){this._refreshInterval&&(clearInterval(this._refreshInterval),this._refreshInterval=null),this.refresh>0&&(this._refreshInterval=window.setInterval(()=>{this._initialize()},this.refresh*1e3))}_initialize(){if(!this.id){console.warn('gouv-query: attribut "id" requis pour identifier la requête');return}this.apiType==="generic"?this._subscribeToSource():this._fetchFromApi()}_subscribeToSource(){if(!this.source){console.warn('gouv-query: attribut "source" requis en mode generic');return}this._unsubscribe&&this._unsubscribe();const e=V(this.source);e!==void 0&&(this._rawData=Array.isArray(e)?e:[e],this._processClientSide()),this._unsubscribe=X(this.source,{onLoaded:h(t=>{this._rawData=Array.isArray(t)?t:[t],this._processClientSide()},"onLoaded"),onLoading:h(()=>{this._loading=!0,L(this.id)},"onLoading"),onError:h(t=>{this._error=t,this._loading=!1,T(this.id,t)},"onError")})}_processClientSide(){try{L(this.id),this._loading=!0;let e=[...this._rawData];const t=this.filter||this.where;t&&(e=this._applyFilters(e,t)),this.groupBy&&(e=this._applyGroupByAndAggregate(e)),this.orderBy&&(e=this._applySort(e)),this.limit>0&&(e=e.slice(0,this.limit)),this._data=e,z(this.id,this._data)}catch(e){this._error=e,T(this.id,this._error),console.error(`gouv-query[${this.id}]: Erreur de traitement`,e)}finally{this._loading=!1}}_applyFilters(e,t){const i=this._parseFilters(t);return e.filter(r=>i.every(s=>this._matchesFilter(r,s)))}_parseFilters(e){const t=[],i=e.split(",").map(r=>r.trim()).filter(Boolean);for(const r of i){const s=r.split(":");if(s.length>=2){const a=s[0],o=s[1];let c;if(s.length>2){const d=s.slice(2).join(":");o==="in"||o==="notin"?c=d.split("|").map(g=>{const f=this._parseValue(g);return typeof f=="boolean"?String(f):f}):c=this._parseValue(d)}t.push({field:a,operator:o,value:c})}}return t}_parseValue(e){return e==="true"?!0:e==="false"?!1:!isNaN(Number(e))&&e!==""?Number(e):e}_matchesFilter(e,t){const i=b(e,t.field);switch(t.operator){case"eq":return i==t.value;case"neq":return i!=t.value;case"gt":return Number(i)>Number(t.value);case"gte":return Number(i)>=Number(t.value);case"lt":return Number(i)<Number(t.value);case"lte":return Number(i)<=Number(t.value);case"contains":return String(i).toLowerCase().includes(String(t.value).toLowerCase());case"notcontains":return!String(i).toLowerCase().includes(String(t.value).toLowerCase());case"in":return Array.isArray(t.value)&&t.value.includes(i);case"notin":return Array.isArray(t.value)&&!t.value.includes(i);case"isnull":return i==null;case"isnotnull":return i!=null;default:return!0}}_applyGroupByAndAggregate(e){const t=this.groupBy.split(",").map(a=>a.trim()).filter(Boolean),i=this._parseAggregates(this.aggregate),r=new Map;for(const a of e){const o=t.map(c=>String(b(a,c)??"")).join("|||");r.has(o)||r.set(o,[]),r.get(o).push(a)}const s=[];for(const[a,o]of r){const c={},d=a.split("|||");t.forEach((g,f)=>{Et(c,g,d[f])});for(const g of i){const f=g.alias||`${g.field}__${g.function}`;Et(c,f,this._computeAggregate(o,g))}s.push(c)}return s}_parseAggregates(e){if(!e)return[];const t=[],i=e.split(",").map(r=>r.trim()).filter(Boolean);for(const r of i){const s=r.split(":");s.length>=2&&t.push({field:s[0],function:s[1],alias:s[2]})}return t}_computeAggregate(e,t){const i=e.map(r=>Number(b(r,t.field))).filter(r=>!isNaN(r));switch(t.function){case"count":return e.length;case"sum":return i.reduce((r,s)=>r+s,0);case"avg":return i.length>0?i.reduce((r,s)=>r+s,0)/i.length:0;case"min":return i.length>0?Math.min(...i):0;case"max":return i.length>0?Math.max(...i):0;default:return 0}}_applySort(e){const t=this.orderBy.split(":");if(t.length<1)return e;const i=t[0],r=(t[1]||"asc").toLowerCase();return[...e].sort((s,a)=>{const o=b(s,i),c=b(a,i),d=Number(o),g=Number(c);if(!isNaN(d)&&!isNaN(g))return r==="desc"?g-d:d-g;const f=String(o??""),_=String(c??"");return r==="desc"?_.localeCompare(f):f.localeCompare(_)})}async _fetchFromApi(){if(this.apiType==="opendatasoft"&&!this.datasetId){console.warn('gouv-query: attribut "dataset-id" requis pour les requêtes OpenDataSoft');return}if(this.apiType==="tabular"&&!this.resource){console.warn('gouv-query: attribut "resource" requis pour les requêtes Tabular');return}this._abortController&&this._abortController.abort(),this._abortController=new AbortController,this._loading=!0,this._error=null,L(this.id);try{this.apiType==="opendatasoft"?await this._fetchFromOdsWithPagination():this.apiType==="tabular"?await this._fetchFromTabularWithPagination():await this._fetchSinglePage()}catch(e){if(e.name==="AbortError")return;this._error=e,T(this.id,this._error),console.error(`gouv-query[${this.id}]: Erreur de requête API`,e)}finally{this._loading=!1}}async _fetchSinglePage(){const e=this._buildApiUrl(),t=await fetch(e,{signal:this._abortController.signal});if(!t.ok)throw new Error(`HTTP ${t.status}: ${t.statusText}`);const i=await t.json();let r=this.transform?b(i,this.transform):i;Array.isArray(r)||(this.apiType==="tabular"&&i.data?r=i.data:r=[r]),this._data=r,z(this.id,this._data)}async _fetchFromOdsWithPagination(){const t=this.limit<=0?Ye*Ee:this.limit,i=Ee;let r=[],s=0,a=-1;for(let o=0;o<Ye;o++){const c=t-r.length;if(c<=0)break;const d=this._buildOpenDataSoftUrl(Math.min(i,c),s),g=await fetch(d,{signal:this._abortController.signal});if(!g.ok)throw new Error(`HTTP ${g.status}: ${g.statusText}`);const f=await g.json(),_=f.results||[];if(r=r.concat(_),typeof f.total_count=="number"&&(a=f.total_count),a>=0&&r.length>=a||_.length<i)break;s+=_.length}a>=0&&r.length<a&&r.length<t&&console.warn(`gouv-query[${this.id}]: pagination incomplete - ${r.length}/${a} resultats recuperes (limite de securite: ${Ye} pages de ${Ee})`),this._data=this.transform?b(r,this.transform):r,z(this.id,this._data)}async _fetchFromTabularWithPagination(){var a;const e=this.limit<=0,t=e?et*Re:this.limit;let i=[],r=-1,s=1;for(let o=0;o<et&&!(t-i.length<=0);o++){const d=this._buildTabularUrl(Re,s),g=await fetch(d,{signal:this._abortController.signal});if(!g.ok)throw new Error(`HTTP ${g.status}: ${g.statusText}`);const f=await g.json(),_=f.data||[];i=i.concat(_),f.meta&&typeof f.meta.total=="number"&&(r=f.meta.total);let P=!1;if((a=f.links)!=null&&a.next)try{const ge=new URL(f.links.next,"https://tabular-api.data.gouv.fr"),Vt=Number(ge.searchParams.get("page"));Vt>0&&(s=Vt,P=!0)}catch{}if(!P||r>=0&&i.length>=r||_.length<Re)break}!e&&i.length>t&&(i=i.slice(0,t)),r>=0&&i.length<r&&i.length<t&&console.warn(`gouv-query[${this.id}]: pagination incomplete - ${i.length}/${r} resultats recuperes (limite de securite: ${et} pages de ${Re})`),this._rawData=i,this._processClientSide()}_buildApiUrl(){if(this.apiType==="opendatasoft")return this._buildOpenDataSoftUrl();if(this.apiType==="tabular")return this._buildTabularUrl();throw new Error(`Type d'API non supporté: ${this.apiType}`)}_buildOpenDataSoftUrl(e,t){const i=this.baseUrl||"https://data.opendatasoft.com",r=new URL(`${i}/api/explore/v2.1/catalog/datasets/${this.datasetId}/records`);if(this.select)r.searchParams.set("select",this.select);else if(this.aggregate&&this.groupBy){const a=this._parseAggregates(this.aggregate),o=[];for(const d of a){const g=d.function==="count"?"count(*)":`${d.function}(${d.field})`,f=d.alias||`${d.field}__${d.function}`;o.push(`${g} as ${f}`)}const c=this.groupBy.split(",").map(d=>d.trim()).filter(Boolean);for(const d of c)o.push(d);r.searchParams.set("select",o.join(", "))}const s=this.where||this.filter;if(s&&r.searchParams.set("where",s),this.groupBy&&r.searchParams.set("group_by",this.groupBy),this.orderBy){const a=this.orderBy.replace(/:(\w+)$/,(o,c)=>` ${c.toUpperCase()}`);r.searchParams.set("order_by",a)}return e!==void 0?r.searchParams.set("limit",String(e)):this.limit>0&&r.searchParams.set("limit",String(Math.min(this.limit,Ee))),t&&t>0&&r.searchParams.set("offset",String(t)),r.toString()}_buildTabularUrl(e,t){let i;if(this.baseUrl)i=this.baseUrl;else{const o=Ft();i=`${o.baseUrl}${o.endpoints.tabular}`}if(!this.resource)throw new Error(`gouv-query: attribut "resource" requis pour l'API Tabular`);const r=window.location.origin!=="null"?window.location.origin:void 0,s=new URL(`${i}/api/resources/${this.resource}/data/`,r),a=this.filter||this.where;if(a){const o=a.split(",").map(c=>c.trim());for(const c of o){const d=c.split(":");if(d.length>=3){const g=d[0],f=this._mapOperatorToTabular(d[1]),_=d.slice(2).join(":");s.searchParams.set(`${g}__${f}`,_)}}}if(this.groupBy){const o=this.groupBy.split(",").map(c=>c.trim());for(const c of o)s.searchParams.append(`${c}__groupby`,"")}if(this.aggregate){const o=this.aggregate.split(",").map(c=>c.trim());for(const c of o){const d=c.split(":");if(d.length>=2){const g=d[0],f=d[1];s.searchParams.append(`${g}__${f}`,"")}}}if(this.orderBy){const o=this.orderBy.split(":"),c=o[0],d=o[1]||"asc";s.searchParams.set(`${c}__sort`,d)}return e?s.searchParams.set("page_size",String(e)):this.limit>0&&s.searchParams.set("page_size",String(this.limit)),t&&s.searchParams.set("page",String(t)),s.toString()}_mapOperatorToTabular(e){return{eq:"exact",neq:"differs",gt:"strictly_greater",gte:"greater",lt:"strictly_less",lte:"less",contains:"contains",notcontains:"notcontains",in:"in",notin:"notin",isnull:"isnull",isnotnull:"isnotnull"}[e]||e}reload(){this._initialize()}getData(){return this._data}isLoading(){return this._loading}getError(){return this._error}},h(ie,"GouvQuery"),ie),w([u({type:String,attribute:"api-type"})],l.GouvQuery.prototype,"apiType",void 0),w([u({type:String})],l.GouvQuery.prototype,"source",void 0),w([u({type:String,attribute:"base-url"})],l.GouvQuery.prototype,"baseUrl",void 0),w([u({type:String,attribute:"dataset-id"})],l.GouvQuery.prototype,"datasetId",void 0),w([u({type:String})],l.GouvQuery.prototype,"resource",void 0),w([u({type:String})],l.GouvQuery.prototype,"select",void 0),w([u({type:String})],l.GouvQuery.prototype,"where",void 0),w([u({type:String})],l.GouvQuery.prototype,"filter",void 0),w([u({type:String,attribute:"group-by"})],l.GouvQuery.prototype,"groupBy",void 0),w([u({type:String})],l.GouvQuery.prototype,"aggregate",void 0),w([u({type:String,attribute:"order-by"})],l.GouvQuery.prototype,"orderBy",void 0),w([u({type:Number})],l.GouvQuery.prototype,"limit",void 0),w([u({type:String})],l.GouvQuery.prototype,"transform",void 0),w([u({type:Number})],l.GouvQuery.prototype,"refresh",void 0),w([m()],l.GouvQuery.prototype,"_loading",void 0),w([m()],l.GouvQuery.prototype,"_error",void 0),w([m()],l.GouvQuery.prototype,"_data",void 0),w([m()],l.GouvQuery.prototype,"_rawData",void 0),l.GouvQuery=w([A("gouv-query")],l.GouvQuery);var G=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.GouvNormalize=(re=class extends ${constructor(){super(...arguments),this.source="",this.numeric="",this.numericAuto=!1,this.rename="",this.trim=!1,this.stripHtml=!1,this.replace="",this.flatten="",this.lowercaseKeys=!1,this._unsubscribe=null,this._unsubscribePageRequests=null}createRenderRoot(){return this}render(){return p``}connectedCallback(){super.connectedCallback(),x("gouv-normalize"),this._initialize()}disconnectedCallback(){super.disconnectedCallback(),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=null),this._unsubscribePageRequests&&(this._unsubscribePageRequests(),this._unsubscribePageRequests=null),this.id&&(Se(this.id),xt(this.id))}updated(e){if(super.updated(e),e.has("source")){this._initialize();return}if(["flatten","numeric","numericAuto","rename","trim","stripHtml","replace","lowercaseKeys"].some(r=>e.has(r))){const r=this.source?V(this.source):void 0;r!==void 0&&this._processData(r)}}_initialize(){if(!this.id){console.warn('gouv-normalize: attribut "id" requis pour identifier la sortie');return}if(!this.source){console.warn('gouv-normalize: attribut "source" requis');return}this._unsubscribe&&this._unsubscribe(),this._unsubscribePageRequests&&(this._unsubscribePageRequests(),this._unsubscribePageRequests=null);const e=V(this.source);e!==void 0&&this._processData(e),this._unsubscribe=X(this.source,{onLoaded:h(t=>{this._processData(t)},"onLoaded"),onLoading:h(()=>{L(this.id)},"onLoading"),onError:h(t=>{T(this.id,t)},"onError")}),this._unsubscribePageRequests=Tt(this.id,t=>{Ze(this.source,t)})}_processData(e){try{L(this.id);let t=Array.isArray(e)?e:[e];this.flatten&&(t=t.map(c=>c==null||typeof c!="object"||Array.isArray(c)?c:this._flattenRow(c,this.flatten)));const i=this._parseNumericFields(),r=this._parsePipeMap(this.rename),s=this._parsePipeMap(this.replace),a=t.map(c=>c==null||typeof c!="object"?c:this._normalizeRow(c,i,r,s));z(this.id,a);const o=Xe(this.source);o&&Mt(this.id,o)}catch(t){T(this.id,t),console.error(`gouv-normalize[${this.id}]: Erreur de normalisation`,t)}}_normalizeRow(e,t,i,r){const s={};for(const[a,o]of Object.entries(e)){const c=this.trim?a.trim():a;let d=o;if(this.trim&&typeof d=="string"&&(d=d.trim()),this.stripHtml&&typeof d=="string"&&(d=d.replace(/<[^>]*>/g,"")),r.size>0&&typeof d=="string"){for(const[_,P]of r)if(d===_){d=P;break}}if(t.has(c))d=Gt(d);else if(this.numericAuto&&typeof d=="string"&&hi(d)){const _=Gt(d,!0);_!==null&&(d=_)}const g=i.get(c)??c,f=this.lowercaseKeys?g.toLowerCase():g;s[f]=d}return s}_flattenRow(e,t){const i=this._resolvePath(e,t);if(i&&typeof i=="object"&&!Array.isArray(i)){const r={...e};return this._deleteByPath(r,t),Object.assign(r,i),r}return e}_resolvePath(e,t){return t.split(".").reduce((i,r)=>i!=null&&typeof i=="object"?i[r]:void 0,e)}_deleteByPath(e,t){const i=t.split(".");delete e[i[0]]}_parseNumericFields(){return this.numeric?new Set(this.numeric.split(",").map(e=>e.trim()).filter(Boolean)):new Set}_parsePipeMap(e){const t=new Map;if(!e)return t;const i=e.split("|");for(const r of i){const s=r.indexOf(":");if(s===-1)continue;const a=r.substring(0,s).trim(),o=r.substring(s+1).trim();a&&t.set(a,o)}return t}},h(re,"GouvNormalize"),re),G([u({type:String})],l.GouvNormalize.prototype,"source",void 0),G([u({type:String})],l.GouvNormalize.prototype,"numeric",void 0),G([u({type:Boolean,attribute:"numeric-auto"})],l.GouvNormalize.prototype,"numericAuto",void 0),G([u({type:String})],l.GouvNormalize.prototype,"rename",void 0),G([u({type:Boolean})],l.GouvNormalize.prototype,"trim",void 0),G([u({type:Boolean,attribute:"strip-html"})],l.GouvNormalize.prototype,"stripHtml",void 0),G([u({type:String})],l.GouvNormalize.prototype,"replace",void 0),G([u({type:String})],l.GouvNormalize.prototype,"flatten",void 0),G([u({type:Boolean,attribute:"lowercase-keys"})],l.GouvNormalize.prototype,"lowercaseKeys",void 0),l.GouvNormalize=G([A("gouv-normalize")],l.GouvNormalize);var S=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.GouvFacets=(se=class extends ${constructor(){super(...arguments),this.source="",this.fields="",this.labels="",this.maxValues=6,this.disjunctive="",this.sort="count",this.searchable="",this.hideEmpty=!1,this.display="",this.urlParams=!1,this.urlParamMap="",this.urlSync=!1,this._rawData=[],this._facetGroups=[],this._activeSelections={},this._expandedFacets=new Set,this._searchQueries={},this._openMultiselectField=null,this._unsubscribe=null,this._popstateHandler=null,this._urlParamsApplied=!1,this._onClickOutsideMultiselect=e=>{if(!this._openMultiselectField)return;const t=e.target,i=this.querySelector(`[data-multiselect="${this._openMultiselectField}"]`);i&&!i.contains(t)&&(this._openMultiselectField=null)}}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),x("gouv-facets"),this._initialize(),document.addEventListener("click",this._onClickOutsideMultiselect),this.urlSync&&(this._popstateHandler=()=>{this._applyUrlParams(),this._buildFacetGroups(),this._applyFilters()},window.addEventListener("popstate",this._popstateHandler))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onClickOutsideMultiselect),this._popstateHandler&&(window.removeEventListener("popstate",this._popstateHandler),this._popstateHandler=null),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=null),this.id&&Se(this.id)}updated(e){if(super.updated(e),e.has("source")){this._initialize();return}["fields","labels","sort","hideEmpty","maxValues","disjunctive","searchable","display"].some(r=>e.has(r))&&this._rawData.length>0&&(this._buildFacetGroups(),this._applyFilters())}_initialize(){if(!this.id){console.warn('gouv-facets: attribut "id" requis pour identifier la sortie');return}if(!this.source){console.warn('gouv-facets: attribut "source" requis');return}this._unsubscribe&&this._unsubscribe(),this._activeSelections={},this._expandedFacets=new Set,this._searchQueries={};const e=V(this.source);e!==void 0&&this._onData(e),this._unsubscribe=X(this.source,{onLoaded:h(t=>{this._onData(t)},"onLoaded"),onLoading:h(()=>{L(this.id)},"onLoading"),onError:h(t=>{T(this.id,t)},"onError")})}_onData(e){this._rawData=Array.isArray(e)?e:[],this.urlParams&&!this._urlParamsApplied&&(this._applyUrlParams(),this._urlParamsApplied=!0),this._buildFacetGroups(),this._applyFilters()}_buildFacetGroups(){const e=this._getFields(),t=this._parseLabels();this._facetGroups=e.map(i=>{const r=this._computeFacetValues(i);return{field:i,label:t.get(i)??i,values:r}}).filter(i=>this.hideEmpty&&i.values.length<=1?!1:i.values.length>0)}_getFields(){return this.fields?tt(this.fields):this._autoDetectFields()}_autoDetectFields(){if(this._rawData.length===0)return[];const e=[],t=this._rawData[0];for(const i of Object.keys(t)){const r=new Set;let s=!0;for(const a of this._rawData){const o=a[i];if(!(o==null||o==="")){if(typeof o!="string"){s=!1;break}if(r.add(o),r.size>50)break}}s&&(r.size<=1||r.size>50||r.size!==this._rawData.length&&e.push(i))}return e}_computeFacetValues(e){const t=this._getDataFilteredExcluding(e),i=new Map;for(const s of t){const a=s[e];if(a==null||a==="")continue;const o=String(a);i.set(o,(i.get(o)??0)+1)}const r=[];for(const[s,a]of i)r.push({value:s,count:a});return this._sortValues(r)}_getDataFilteredExcluding(e){const t=Object.keys(this._activeSelections).filter(i=>i!==e&&this._activeSelections[i].size>0);return t.length===0?this._rawData:this._rawData.filter(i=>t.every(r=>{const s=this._activeSelections[r],a=i[r];return a==null?!1:s.has(String(a))}))}_sortValues(e){const t=[...e];switch(this.sort){case"count":t.sort((i,r)=>r.count-i.count);break;case"-count":t.sort((i,r)=>i.count-r.count);break;case"alpha":t.sort((i,r)=>i.value.localeCompare(r.value,"fr"));break;case"-alpha":t.sort((i,r)=>r.value.localeCompare(i.value,"fr"));break;default:t.sort((i,r)=>r.count-i.count)}return t}_applyFilters(){const e=Object.keys(this._activeSelections).filter(i=>this._activeSelections[i].size>0);let t;e.length===0?t=this._rawData:t=this._rawData.filter(i=>e.every(r=>{const s=this._activeSelections[r],a=i[r];return a==null?!1:s.has(String(a))})),z(this.id,t)}_parseLabels(){const e=new Map;if(!this.labels)return e;const t=this.labels.split("|");for(const i of t){const r=i.indexOf(":");if(r===-1)continue;const s=i.substring(0,r).trim(),a=i.substring(r+1).trim();s&&e.set(s,a)}return e}_parseDisplayModes(){const e=new Map;if(!this.display)return e;const t=this.display.split("|");for(const i of t){const r=i.indexOf(":");if(r===-1)continue;const s=i.substring(0,r).trim(),a=i.substring(r+1).trim();s&&(a==="checkbox"||a==="select"||a==="multiselect")&&e.set(s,a)}return e}_getDisplayMode(e){return this._parseDisplayModes().get(e)??"checkbox"}_toggleValue(e,t){const i={...this._activeSelections},r=new Set(i[e]??[]),s=this._getDisplayMode(e),a=tt(this.disjunctive),o=s==="multiselect"||s==="checkbox"&&a.includes(e);r.has(t)?r.delete(t):(o||r.clear(),r.add(t)),r.size===0?delete i[e]:i[e]=r,this._activeSelections=i,this._buildFacetGroups(),this._applyFilters(),this.urlSync&&this._syncUrl()}_handleSelectChange(e,t){const r=t.target.value,s={...this._activeSelections};r?s[e]=new Set([r]):delete s[e],this._activeSelections=s,this._buildFacetGroups(),this._applyFilters(),this.urlSync&&this._syncUrl()}_clearFieldSelections(e){const t={...this._activeSelections};delete t[e],this._activeSelections=t,this._buildFacetGroups(),this._applyFilters(),this.urlSync&&this._syncUrl()}_toggleMultiselectDropdown(e){this._openMultiselectField=this._openMultiselectField===e?null:e}_toggleExpand(e){const t=new Set(this._expandedFacets);t.has(e)?t.delete(e):t.add(e),this._expandedFacets=t}_handleSearch(e,t){const i=t.target;this._searchQueries={...this._searchQueries,[e]:i.value}}_clearAll(){this._activeSelections={},this._searchQueries={},this._buildFacetGroups(),this._applyFilters(),this.urlSync&&this._syncUrl()}_parseUrlParamMap(){const e=new Map;if(!this.urlParamMap)return e;const t=this.urlParamMap.split("|");for(const i of t){const r=i.indexOf(":");if(r===-1)continue;const s=i.substring(0,r).trim(),a=i.substring(r+1).trim();s&&a&&e.set(s,a)}return e}_applyUrlParams(){const e=new URLSearchParams(window.location.search),t=this._parseUrlParamMap(),i={};for(const[r,s]of e.entries()){const a=t.size>0?t.get(r)??null:r;if(!a)continue;const o=s.split(",").map(c=>c.trim()).filter(Boolean);i[a]||(i[a]=new Set);for(const c of o)i[a].add(c)}Object.keys(i).length>0&&(this._activeSelections=i)}_syncUrl(){const e=new URLSearchParams,t=this._parseUrlParamMap(),i=new Map;for(const[a,o]of t)i.set(o,a);for(const[a,o]of Object.entries(this._activeSelections)){if(o.size===0)continue;const c=i.get(a)??a;e.set(c,[...o].join(","))}const r=e.toString(),s=r?`${window.location.pathname}?${r}${window.location.hash}`:`${window.location.pathname}${window.location.hash}`;window.history.replaceState(null,"",s)}render(){if(this._rawData.length===0||this._facetGroups.length===0)return v;const e=Object.keys(this._activeSelections).some(t=>this._activeSelections[t].size>0);return p`
    ...
    `}_renderFacetGroup(e){switch(this._getDisplayMode(e.field)){case"select":return this._renderSelectGroup(e);case"multiselect":return this._renderMultiselectGroup(e);default:return this._renderCheckboxGroup(e)}}_renderCheckboxGroup(e){const i=tt(this.searchable).includes(e.field),r=(this._searchQueries[e.field]??"").toLowerCase(),s=this._expandedFacets.has(e.field),a=this._activeSelections[e.field]??new Set;let o=e.values;i&&r&&(o=o.filter(f=>f.value.toLowerCase().includes(r)));const c=s?o:o.slice(0,this.maxValues),d=o.length>this.maxValues,g=`facet-${this.id}-${e.field}`;return p`
      <fieldset class="gouv-facets__group fr-fieldset" aria-labelledby="${g}-legend">
        ...
        <ul class="gouv-facets__values" role="group">
          ${c.map(f=>{const _=`${g}-${f.value.replace(/[^a-zA-Z0-9]/g,"_")}`,P=a.has(f.value);return p`
    ...
    `}},h(se,"GouvFacets"),se),S([u({type:String})],l.GouvFacets.prototype,"source",void 0),S([u({type:String})],l.GouvFacets.prototype,"fields",void 0),S([u({type:String})],l.GouvFacets.prototype,"labels",void 0),S([u({type:Number,attribute:"max-values"})],l.GouvFacets.prototype,"maxValues",void 0),S([u({type:String})],l.GouvFacets.prototype,"disjunctive",void 0),S([u({type:String})],l.GouvFacets.prototype,"sort",void 0),S([u({type:String})],l.GouvFacets.prototype,"searchable",void 0),S([u({type:Boolean,attribute:"hide-empty"})],l.GouvFacets.prototype,"hideEmpty",void 0),S([u({type:String})],l.GouvFacets.prototype,"display",void 0),S([u({type:Boolean,attribute:"url-params"})],l.GouvFacets.prototype,"urlParams",void 0),S([u({type:String,attribute:"url-param-map"})],l.GouvFacets.prototype,"urlParamMap",void 0),S([u({type:Boolean,attribute:"url-sync"})],l.GouvFacets.prototype,"urlSync",void 0),S([m()],l.GouvFacets.prototype,"_rawData",void 0),S([m()],l.GouvFacets.prototype,"_facetGroups",void 0),S([m()],l.GouvFacets.prototype,"_activeSelections",void 0),S([m()],l.GouvFacets.prototype,"_expandedFacets",void 0),S([m()],l.GouvFacets.prototype,"_searchQueries",void 0),S([m()],l.GouvFacets.prototype,"_openMultiselectField",void 0),l.GouvFacets=S([A("gouv-facets")],l.GouvFacets);function tt(n){return n?n.split(",").map(e=>e.trim()).filter(Boolean):[]}h(tt,"_parseCSV");var C=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.GouvSearch=(ae=class extends ${constructor(){super(...arguments),this.source="",this.fields="",this.placeholder="Rechercher…",this.label="Rechercher",this.debounce=300,this.minLength=0,this.highlight=!1,this.operator="contains",this.srLabel=!1,this.count=!1,this.urlSearchParam="",this.urlSync=!1,this._allData=[],this._filteredData=[],this._term="",this._resultCount=0,this._debounceTimer=null,this._unsubscribe=null,this._urlParamApplied=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),x("gouv-search"),this._initialize()}disconnectedCallback(){super.disconnectedCallback(),this._debounceTimer!==null&&(clearTimeout(this._debounceTimer),this._debounceTimer=null),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=null),this.id&&Se(this.id)}updated(e){if(super.updated(e),e.has("source")){this._initialize();return}["fields","operator","minLength","highlight"].some(r=>e.has(r))&&this._allData.length>0&&this._applyFilter()}clear(){this._term="";const e=this.querySelector("input");e&&(e.value=""),this._applyFilter()}search(e){this._term=e;const t=this.querySelector("input");t&&(t.value=e),this._applyFilter()}getData(){return this._filteredData}setData(e){this._allData=Array.isArray(e)?e:[],this._applyFilter()}_initialize(){if(!this.id){console.warn('gouv-search: attribut "id" requis');return}if(!this.source){console.warn('gouv-search: attribut "source" requis');return}this._unsubscribe&&this._unsubscribe();const e=V(this.source);e!==void 0&&this._onData(e),this._unsubscribe=X(this.source,{onLoaded:h(t=>{this._onData(t)},"onLoaded"),onLoading:h(()=>{L(this.id)},"onLoading"),onError:h(t=>{T(this.id,t)},"onError")})}_onData(e){this._allData=Array.isArray(e)?e:[],this.urlSearchParam&&!this._urlParamApplied&&(this._applyUrlSearchParam(),this._urlParamApplied=!0),this._applyFilter()}_applyUrlSearchParam(){if(!this.urlSearchParam)return;const t=new URLSearchParams(window.location.search).get(this.urlSearchParam);t&&(this._term=t)}_applyFilter(){const e=this._term;if(!e||e.length<this.minLength)this._filteredData=[...this._allData];else{const t=this._getFields(),i=this.operator||"contains",r=this._normalize(e);this._filteredData=this._allData.filter(s=>this._matchRecord(s,r,t,i))}this.highlight&&e&&e.length>=this.minLength&&(this._filteredData=this._filteredData.map(t=>this._addHighlight(t,e))),this._resultCount=this._filteredData.length,this._dispatch()}_matchRecord(e,t,i,r){const s=i.length>0?i:Object.keys(e).filter(a=>!a.startsWith("_"));switch(r){case"starts":return s.some(a=>this._normalize(String(e[a]??"")).split(/\s+/).some(c=>c.startsWith(t)));case"words":return t.split(/\s+/).filter(Boolean).every(o=>s.some(c=>this._normalize(String(e[c]??"")).includes(o)));case"contains":default:return s.some(a=>this._normalize(String(e[a]??"")).includes(t))}}_normalize(e){return String(e).normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}_getFields(){return this.fields?this.fields.split(",").map(e=>e.trim()).filter(Boolean):[]}_addHighlight(e,t){const i={...e},r=t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),s=new RegExp("("+r+")","gi"),a=this._getFields(),o=a.length>0?a:Object.keys(e).filter(d=>typeof e[d]=="string"),c=[];return o.forEach(d=>{typeof e[d]=="string"&&c.push(e[d].replace(s,"<mark>$1</mark>"))}),i._highlight=c.join(" … "),i}_onInput(e){this._term=e,this._debounceTimer!==null&&clearTimeout(this._debounceTimer),this._debounceTimer=setTimeout(()=>{this._debounceTimer=null,this._applyFilter()},this.debounce)}_onSubmit(){this._debounceTimer!==null&&(clearTimeout(this._debounceTimer),this._debounceTimer=null),this._applyFilter()}_dispatch(){this.id&&(z(this.id,this._filteredData),this.urlSync&&this.urlSearchParam&&this._syncUrl(),document.dispatchEvent(new CustomEvent("gouv-search-change",{bubbles:!0,composed:!0,detail:{sourceId:this.id,term:this._term,count:this._filteredData.length}})))}_syncUrl(){const e=new URLSearchParams(window.location.search);this._term?e.set(this.urlSearchParam,this._term):e.delete(this.urlSearchParam);const t=e.toString(),i=t?`${window.location.pathname}?${t}${window.location.hash}`:`${window.location.pathname}${window.location.hash}`;window.history.replaceState(null,"",i)}render(){const e=this.id||"search",t=this.srLabel?"fr-label sr-only":"fr-label";return p`
      ...
      `:v}
    `}},h(ae,"GouvSearch"),ae),C([u({type:String})],l.GouvSearch.prototype,"source",void 0),C([u({type:String})],l.GouvSearch.prototype,"fields",void 0),C([u({type:String})],l.GouvSearch.prototype,"placeholder",void 0),C([u({type:String})],l.GouvSearch.prototype,"label",void 0),C([u({type:Number})],l.GouvSearch.prototype,"debounce",void 0),C([u({type:Number,attribute:"min-length"})],l.GouvSearch.prototype,"minLength",void 0),C([u({type:Boolean})],l.GouvSearch.prototype,"highlight",void 0),C([u({type:String})],l.GouvSearch.prototype,"operator",void 0),C([u({type:Boolean,attribute:"sr-label"})],l.GouvSearch.prototype,"srLabel",void 0),C([u({type:Boolean})],l.GouvSearch.prototype,"count",void 0),C([u({type:String,attribute:"url-search-param"})],l.GouvSearch.prototype,"urlSearchParam",void 0),C([u({type:Boolean,attribute:"url-sync"})],l.GouvSearch.prototype,"urlSync",void 0),C([m()],l.GouvSearch.prototype,"_allData",void 0),C([m()],l.GouvSearch.prototype,"_filteredData",void 0),C([m()],l.GouvSearch.prototype,"_term",void 0),C([m()],l.GouvSearch.prototype,"_resultCount",void 0),l.GouvSearch=C([A("gouv-search")],l.GouvSearch);function Ce(n){const t=class t extends n{constructor(){super(...arguments),this._sourceLoading=!1,this._sourceData=null,this._sourceError=null,this._unsubscribeSource=null}onSourceData(r){}connectedCallback(){super.connectedCallback(),this._subscribeToSource()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupSubscription()}updated(r){super.updated(r),r.has("source")&&this._subscribeToSource()}_subscribeToSource(){this._cleanupSubscription();const r=this.source;if(!r)return;const s=V(r);s!==void 0&&(this._sourceData=s,this.onSourceData(s)),this._unsubscribeSource=X(r,{onLoaded:h(a=>{this._sourceData=a,this._sourceLoading=!1,this._sourceError=null,this.onSourceData(a),this.requestUpdate()},"onLoaded"),onLoading:h(()=>{this._sourceLoading=!0,this.requestUpdate()},"onLoading"),onError:h(a=>{this._sourceError=a,this._sourceLoading=!1,this.requestUpdate()},"onError")})}_cleanupSubscription(){this._unsubscribeSource&&(this._unsubscribeSource(),this._unsubscribeSource=null)}};h(t,"SourceSubscriberElement");let e=t;return e}h(Ce,"SourceSubscriberMixin");function it(n,e="nombre"){if(n==null||n==="")return"—";const t=typeof n=="string"?parseFloat(n):n;if(isNaN(t))return"—";switch(e){case"nombre":return rt(t);case"pourcentage":return Lt(t);case"euro":return Nt(t);case"decimal":return mi(t);default:return rt(t)}}h(it,"formatValue");function rt(n){return new Intl.NumberFormat("fr-FR",{maximumFractionDigits:0}).format(Math.round(n))}h(rt,"formatNumber");function Lt(n){return new Intl.NumberFormat("fr-FR",{style:"percent",minimumFractionDigits:0,maximumFractionDigits:1}).format(n/100)}h(Lt,"formatPercentage");function Nt(n){return new Intl.NumberFormat("fr-FR",{style:"currency",currency:"EUR",minimumFractionDigits:0,maximumFractionDigits:0}).format(n)}h(Nt,"formatCurrency");function mi(n){return new Intl.NumberFormat("fr-FR",{minimumFractionDigits:1,maximumFractionDigits:2}).format(n)}h(mi,"formatDecimal");function vi(n){const e=typeof n=="string"?new Date(n):n;return isNaN(e.getTime())?"—":new Intl.DateTimeFormat("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric"}).format(e)}h(vi,"formatDate");function bi(n,e,t){return e!==void 0&&n>=e?"vert":t!==void 0&&n>=t?"orange":e!==void 0||t!==void 0?"rouge":"bleu"}h(bi,"getColorBySeuil");function Ot(n){const e=n.split(":");if(e.length===1)return e[0]==="count"?{type:"count",field:""}:{type:"direct",field:e[0]};const t=e[0],i=e[1];if(e.length===3){let r=e[2];return r==="true"?r=!0:r==="false"?r=!1:isNaN(Number(r))||(r=Number(r)),{type:t,field:i,filterField:i,filterValue:r}}return{type:t,field:i}}h(Ot,"parseExpression");function st(n,e){const t=Ot(e);if(t.type==="direct"&&!Array.isArray(n))return n[t.field];if(!Array.isArray(n))return null;const i=n;switch(t.type){case"direct":case"first":return i.length>0?i[0][t.field]:null;case"last":return i.length>0?i[i.length-1][t.field]:null;case"count":return t.filterValue!==void 0?i.filter(s=>s[t.field]===t.filterValue).length:i.length;case"sum":return i.reduce((s,a)=>{const o=Number(a[t.field]);return s+(isNaN(o)?0:o)},0);case"avg":return i.length===0?null:i.reduce((s,a)=>{const o=Number(a[t.field]);return s+(isNaN(o)?0:o)},0)/i.length;case"min":return i.length===0?null:Math.min(...i.map(s=>Number(s[t.field])).filter(s=>!isNaN(s)));case"max":return i.length===0?null:Math.max(...i.map(s=>Number(s[t.field])).filter(s=>!isNaN(s)));default:return null}}h(st,"computeAggregation");var R=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};const zt={vert:"gouv-kpi--success",orange:"gouv-kpi--warning",rouge:"gouv-kpi--error",bleu:"gouv-kpi--info"};l.GouvKpi=(ne=class extends Ce($){constructor(){super(...arguments),this.source="",this.valeur="",this.label="",this.description="",this.icone="",this.format="nombre",this.tendance="",this.couleur=""}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),x("gouv-kpi")}_computeValue(){return!this._sourceData||!this.valeur?null:st(this._sourceData,this.valeur)}_getColor(){if(this.couleur)return this.couleur;const e=this._computeValue();return typeof e!="number"?"bleu":bi(e,this.seuilVert,this.seuilOrange)}_getTendanceInfo(){if(!this.tendance||!this._sourceData)return null;const e=st(this._sourceData,this.tendance);return typeof e!="number"?null:{value:e,direction:e>0?"up":e<0?"down":"stable"}}_getAriaLabel(){if(this.description)return this.description;const e=this._computeValue(),t=it(e,this.format);return`${this.label}: ${t}`}render(){const e=this._computeValue(),t=it(e,this.format),i=zt[this._getColor()]||zt.bleu,r=this._getTendanceInfo();return p`
      <div
        class="gouv-kpi ${i}"
        role="figure"
    ...
    `}},h(ne,"GouvKpi"),ne),l.GouvKpi.styles=ft``,R([u({type:String})],l.GouvKpi.prototype,"source",void 0),R([u({type:String})],l.GouvKpi.prototype,"valeur",void 0),R([u({type:String})],l.GouvKpi.prototype,"label",void 0),R([u({type:String})],l.GouvKpi.prototype,"description",void 0),R([u({type:String})],l.GouvKpi.prototype,"icone",void 0),R([u({type:String})],l.GouvKpi.prototype,"format",void 0),R([u({type:String})],l.GouvKpi.prototype,"tendance",void 0),R([u({type:Number,attribute:"seuil-vert"})],l.GouvKpi.prototype,"seuilVert",void 0),R([u({type:Number,attribute:"seuil-orange"})],l.GouvKpi.prototype,"seuilOrange",void 0),R([u({type:String})],l.GouvKpi.prototype,"couleur",void 0),l.GouvKpi=R([A("gouv-kpi")],l.GouvKpi);var D=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.GouvDatalist=(oe=class extends Ce($){constructor(){super(...arguments),this.source="",this.colonnes="",this.recherche=!1,this.filtres="",this.tri="",this.pagination=0,this.export="",this._data=[],this._searchQuery="",this._activeFilters={},this._sort=null,this._currentPage=1,this._serverPagination=!1,this._serverTotal=0,this._serverPageSize=0}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),x("gouv-datalist"),this._initSort()}updated(e){super.updated(e),e.has("tri")&&this._initSort()}onSourceData(e){this._data=Array.isArray(e)?e:[];const t=this.source?Xe(this.source):void 0;t&&t.total>0?(this._serverPagination=!0,this._serverTotal=t.total,this._serverPageSize=t.pageSize,this._currentPage=t.page):(this._serverPagination=!1,this._currentPage=1)}parseColumns(){return this.colonnes?this.colonnes.split(",").map(e=>{const[t,i]=e.trim().split(":");return{key:t.trim(),label:(i==null?void 0:i.trim())||t.trim()}}):[]}_getFilterableColumns(){return this.filtres?this.filtres.split(",").map(e=>e.trim()):[]}_initSort(){if(this.tri){const[e,t]=this.tri.split(":");this._sort={key:e,direction:t||"asc"}}}_getUniqueValues(e){const t=new Set;return this._data.forEach(i=>{const r=i[e];r!=null&&t.add(String(r))}),Array.from(t).sort()}getFilteredData(){let e=[...this._data];if(this._searchQuery){const t=this._searchQuery.toLowerCase();e=e.filter(i=>Object.values(i).some(r=>String(r).toLowerCase().includes(t)))}if(Object.entries(this._activeFilters).forEach(([t,i])=>{i&&(e=e.filter(r=>String(r[t])===i))}),this._sort){const{key:t,direction:i}=this._sort;e.sort((r,s)=>{const a=r[t],o=s[t];if(a===o)return 0;if(a==null)return 1;if(o==null)return-1;const c=typeof a=="number"&&typeof o=="number"?a-o:String(a).localeCompare(String(o),"fr");return i==="desc"?-c:c})}return e}_getPaginatedData(){const e=this.getFilteredData();if(this._serverPagination||!this.pagination||this.pagination<=0)return e;const t=(this._currentPage-1)*this.pagination;return e.slice(t,t+this.pagination)}_getTotalPages(){return this._serverPagination?Math.ceil(this._serverTotal/this._serverPageSize):!this.pagination||this.pagination<=0?1:Math.ceil(this.getFilteredData().length/this.pagination)}_handleSearch(e){this._searchQuery=e.target.value,this._currentPage=1}_handleFilter(e,t){this._activeFilters={...this._activeFilters,[e]:t.target.value},this._currentPage=1}_handleSort(e){var t;((t=this._sort)==null?void 0:t.key)===e?this._sort={key:e,direction:this._sort.direction==="asc"?"desc":"asc"}:this._sort={key:e,direction:"asc"}}_handlePageChange(e){this._currentPage=e,this._serverPagination&&this.source&&Ze(this.source,e)}_exportCsv(){const e=this.parseColumns(),t=this.getFilteredData(),i=e.map(d=>d.label).join(";"),r=t.map(d=>e.map(g=>{const f=String(d[g.key]??"");return f.includes(";")||f.includes('"')?`"${f.replace(/"/g,'""')}"`:f}).join(";")),s=[i,...r].join(`
`),a=new Blob([s],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),c=document.createElement("a");c.href=o,c.download="export.csv",c.click(),URL.revokeObjectURL(o)}_exportHtml(){const e=this.parseColumns(),t=this.getFilteredData(),i=e.map(d=>`<th>${Qe(d.label)}</th>`).join(""),r=t.map(d=>`<tr>${e.map(f=>{const _=d[f.key];return`<td>${_==null?"":Qe(String(_))}</td>`}).join("")}</tr>`).join(`
`),s=`<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="utf-8">
...
${r}
    ...
    `}},h(oe,"GouvDatalist"),oe),l.GouvDatalist.styles=ft``,D([u({type:String})],l.GouvDatalist.prototype,"source",void 0),D([u({type:String})],l.GouvDatalist.prototype,"colonnes",void 0),D([u({type:Boolean})],l.GouvDatalist.prototype,"recherche",void 0),D([u({type:String})],l.GouvDatalist.prototype,"filtres",void 0),D([u({type:String})],l.GouvDatalist.prototype,"tri",void 0),D([u({type:Number})],l.GouvDatalist.prototype,"pagination",void 0),D([u({type:String})],l.GouvDatalist.prototype,"export",void 0),D([m()],l.GouvDatalist.prototype,"_data",void 0),D([m()],l.GouvDatalist.prototype,"_searchQuery",void 0),D([m()],l.GouvDatalist.prototype,"_activeFilters",void 0),D([m()],l.GouvDatalist.prototype,"_sort",void 0),D([m()],l.GouvDatalist.prototype,"_currentPage",void 0),D([m()],l.GouvDatalist.prototype,"_serverPagination",void 0),l.GouvDatalist=D([A("gouv-datalist")],l.GouvDatalist);var F=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.GouvDisplay=(le=class extends Ce($){constructor(){super(...arguments),this.source="",this.cols=1,this.pagination=0,this.empty="Aucun resultat",this.gap="fr-grid-row--gutters",this.uidField="",this._data=[],this._currentPage=1,this._serverPagination=!1,this._serverTotal=0,this._serverPageSize=0,this._templateContent="",this._hashScrollDone=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),x("gouv-display"),this._captureTemplate()}onSourceData(e){this._data=Array.isArray(e)?e:[],this._hashScrollDone=!1;const t=this.source?Xe(this.source):void 0;t&&t.total>0?(this._serverPagination=!0,this._serverTotal=t.total,this._serverPageSize=t.pageSize,this._currentPage=t.page):(this._serverPagination=!1,this._currentPage=1)}updated(e){if(super.updated(e),!this._hashScrollDone&&this._data.length>0&&window.location.hash){this._hashScrollDone=!0;const t=window.location.hash.substring(1);requestAnimationFrame(()=>{const i=this.querySelector(`#${CSS.escape(t)}`);i&&i.scrollIntoView({behavior:"smooth",block:"center"})})}}_captureTemplate(){const e=this.querySelector("template");e&&(this._templateContent=e.innerHTML)}_renderItem(e,t){if(!this._templateContent)return"";let i=this._templateContent;return i=i.replace(/\{\{\{([^}]+)\}\}\}/g,(r,s)=>this._resolveExpression(e,s.trim(),t)),i=i.replace(/\{\{([^}]+)\}\}/g,(r,s)=>{const a=this._resolveExpression(e,s.trim(),t);return Qe(a)}),i}_resolveExpression(e,t,i){if(t==="$index")return String(i);if(t==="$uid")return this._getItemUid(e,i);let r=t,s="";const a=t.indexOf("|");a!==-1&&(r=t.substring(0,a).trim(),s=t.substring(a+1).trim());const o=b(e,r);return o==null?s:String(o)}_getPaginatedData(){if(this._serverPagination)return this._data;if(!this.pagination||this.pagination<=0)return this._data;const e=(this._currentPage-1)*this.pagination;return this._data.slice(e,e+this.pagination)}_getTotalPages(){return this._serverPagination?Math.ceil(this._serverTotal/this._serverPageSize):!this.pagination||this.pagination<=0?1:Math.ceil(this._data.length/this.pagination)}_handlePageChange(e){this._currentPage=e,this._serverPagination&&this.source&&Ze(this.source,e)}_getColClass(){const e=Math.max(1,Math.min(6,this.cols));return`fr-col-12 fr-col-md-${Math.floor(12/e)}`}_getItemUid(e,t){if(this.uidField){const i=b(e,this.uidField);if(i!=null&&i!=="")return`item-${String(i).replace(/[^a-zA-Z0-9_-]/g,"_")}`}return`item-${t}`}_renderGrid(e){const t=this._getColClass(),i=this.pagination>0?(this._currentPage-1)*this.pagination:0,r=e.map((a,o)=>{const c=i+o,d=this._renderItem(a,c),g=this._getItemUid(a,c);return`<div class="${t}" id="${g}">${d}</div>`}).join(""),s=`<div class="fr-grid-row ${this.gap}">${r}</div>`;return p`<div .innerHTML="${s}"></div>`}_renderPagination(e){if(this.pagination<=0||e<=1)return"";const t=[];for(let i=Math.max(1,this._currentPage-2);i<=Math.min(e,this._currentPage+2);i++)t.push(i);return p`
    ...
    `}},h(ue,"AppHeader"),ue),Ge([u({type:String,attribute:"current-page"})],l.AppHeader.prototype,"currentPage",void 0),Ge([u({type:String,attribute:"base-path"})],l.AppHeader.prototype,"basePath",void 0),Ge([m()],l.AppHeader.prototype,"_favCount",void 0),l.AppHeader=Ge([A("app-header")],l.AppHeader);var Ut=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};l.AppFooter=(he=class extends ${constructor(){super(...arguments),this.basePath=""}get _base(){const e=this.basePath;return e?e.endsWith("/")?e:e+"/":""}createRenderRoot(){return this}render(){return p`
    ...
    `}},h(pe,"AppLayoutDemo"),pe),Pe([u({type:String})],l.AppLayoutDemo.prototype,"title",void 0),Pe([u({type:String})],l.AppLayoutDemo.prototype,"icon",void 0),Pe([u({type:String,attribute:"active-path"})],l.AppLayoutDemo.prototype,"activePath",void 0),Pe([u({type:String,attribute:"base-path"})],l.AppLayoutDemo.prototype,"basePath",void 0),l.AppLayoutDemo=Pe([A("app-layout-demo")],l.AppLayoutDemo);var H=function(n,e,t,i){var r=arguments.length,s=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(n,e,t,i);else for(var o=n.length-1;o>=0;o--)(a=n[o])&&(s=(r<3?a(s):r>3?a(e,t,s):a(e,t))||s);return r>3&&s&&Object.defineProperty(e,t,s),s};let U=(fe=class extends ${constructor(){super(...arguments),this.showDataTab=!1,this.showSaveButton=!1,this.showPlaygroundButton=!1,this.tabLabels="Aperçu,Code,Données",this.activeTab="preview",this._activeTab="preview",this._previewContent=[],this._codeContent=[],this._dataContent=[],this._contentMoved=!1}createRenderRoot(){return this}connectedCallback(){super.connectedCallback(),this._activeTab=this.activeTab,this._saveSlotContent()}_saveSlotContent(){this._previewContent=Array.from(this.querySelectorAll('[slot="preview"]')),this._codeContent=Array.from(this.querySelectorAll('[slot="code"]')),this._dataContent=Array.from(this.querySelectorAll('[slot="data"]'))}firstUpdated(){this._moveContent()}updated(){this._contentMoved||this._moveContent()}_moveContent(){const e=this.querySelector("#tab-preview"),t=this.querySelector("#tab-code"),i=this.querySelector("#tab-data");e&&this._previewContent.forEach(r=>e.appendChild(r)),t&&this._codeContent.forEach(r=>t.appendChild(r)),i&&this._dataContent.forEach(r=>i.appendChild(r)),this._contentMoved=!0}setActiveTab(e){this._activeTab=e,this.requestUpdate()}getActiveTab(){return this._activeTab}_handleTabClick(e){this._activeTab=e,this.dispatchEvent(new CustomEvent("tab-change",{detail:{tab:e},bubbles:!0,composed:!0})),this.requestUpdate()}_getTabLabels(){return this.tabLabels.split(",").map(e=>e.trim())}_handleSaveClick(){this.dispatchEvent(new CustomEvent("save-favorite",{bubbles:!0,composed:!0}))}_handlePlaygroundClick(){this.dispatchEvent(new CustomEvent("open-playground",{bubbles:!0,composed:!0}))}render(){const e=this._getTabLabels(),[t,i,r]=e;return p`
    ...
    `}},h(fe,"AppPreviewPanel"),fe);H([u({type:Boolean,attribute:"show-data-tab"})],U.prototype,"showDataTab",void 0),H([u({type:Boolean,attribute:"show-save-button"})],U.prototype,"showSaveButton",void 0),H([u({type:Boolean,attribute:"show-playground-button"})],U.prototype,"showPlaygroundButton",void 0),H([u({type:String,attribute:"tab-labels"})],U.prototype,"tabLabels",void 0),H([u({type:String,attribute:"active-tab"})],U.prototype,"activeTab",void 0),H([m()],U.prototype,"_activeTab",void 0),U=H([A("app-preview-panel")],U);function jt(n,e,t){return n.map(i=>({label:String(b(i,e)??"N/A"),value:Number(b(i,t))||0}))}h(jt,"extractLabelValues");function qt(n,e){if(e==="none")return n;const t=new Map;for(const r of n){const s=t.get(r.label)||[];s.push(r.value),t.set(r.label,s)}const i=[];for(const[r,s]of t)i.push({label:r,value:$i(s,e)});return i}h(qt,"aggregateByLabel");function $i(n,e){switch(e){case"sum":return n.reduce((t,i)=>t+i,0);case"avg":return n.reduce((t,i)=>t+i,0)/n.length;case"count":return n.length;case"min":return Math.min(...n);case"max":return Math.max(...n);default:return n[0]||0}}h($i,"computeGroupValue");function Bt(n,e){return e==="none"?n:[...n].sort((t,i)=>e==="desc"?i.value-t.value:t.value-i.value)}h(Bt,"sortByValue");function wi(n,e,t,i="none",r="none",s=0){if(!n||n.length===0)return{labels:[],values:[]};let a=jt(n,e,t);return a=qt(a,i),a=Bt(a,r),s>0&&(a=a.slice(0,s)),{labels:a.map(o=>o.label),values:a.map(o=>Math.round(o.value*100)/100)}}h(wi,"processChartData"),l.DATA_EVENTS=k,l.SourceSubscriberMixin=Ce,l.aggregateByLabel=qt,l.computeAggregation=st,l.dispatchDataError=T,l.dispatchDataLoaded=z,l.dispatchDataLoading=L,l.extractLabelValues=jt,l.formatCurrency=Nt,l.formatDate=vi,l.formatNumber=rt,l.formatPercentage=Lt,l.formatValue=it,l.getByPath=b,l.getByPathOrDefault=ci,l.getDataCache=V,l.hasPath=li,l.parseExpression=Ot,l.processChartData=wi,l.sortByValue=Bt,l.subscribeToSource=X,Object.defineProperty(l,Symbol.toStringTag,{value:"Module"})}));
