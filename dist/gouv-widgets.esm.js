...
var a = (r, s) => Ir(r, "name", { value: s, configurable: !0 });
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ze = globalThis, hi = ze.ShadowRoot && (ze.ShadyCSS === void 0 || ze.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Fi = Symbol(), Zi = /* @__PURE__ */ new WeakMap();
var it;
let RM = (it = class {
  constructor(s, t, e) {
  ...
  get styleSheet() {
    ...
    if (hi && s === void 0) {
      ...
      e && (s = Zi.get(t)), s === void 0 && ((this.o = s = new CSSStyleSheet()).replaceSync(this.cssText), e && Zi.set(t, s));
    }
    return s;
  }
  toString() {
...
const Wr = /* @__PURE__ */ a((r) => new RM(typeof r == "string" ? r : r + "", void 0, Fi), "r$4"), BM = /* @__PURE__ */ a((r, ...s) => {
  const t = r.length === 1 ? r[0] : s.reduce((e, i, M) => e + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(i) + r[M + 1], r[0]);
  return new RM(t, r, Fi);
}, "i$3"), Xr = /* @__PURE__ */ a((r, s) => {
  if (hi) r.adoptedStyleSheets = s.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
  else for (const t of s) {
    const e = document.createElement("style"), i = ze.litNonce;
    i !== void 0 && e.setAttribute("nonce", i), e.textContent = t.cssText, r.appendChild(e);
  }
}, "S$1"), Pi = hi ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((s) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: fr, defineProperty: gr, getOwnPropertyDescriptor: jr, getOwnPropertyNames: Cr, getOwnPropertySymbols: Or, getPrototypeOf: Er } = Object, Es = globalThis, Gi = Es.trustedTypes, mr = Gi ? Gi.emptyScript : "", Ce = Es.reactiveElementPolyfillSupport, Yt = /* @__PURE__ */ a((r, s) => r, "d$1"), be = { toAttribute(r, s) {
  switch (s) {
    case Boolean:
      r = r ? mr : null;
      break;
  ...
  return t;
} }, Di = /* @__PURE__ */ a((r, s) => !fr(r, s), "f$1"), Hi = { attribute: !0, type: String, converter: be, reflect: !1, useDefault: !1, hasChanged: Di };
...
let st = (Mt = class extends HTMLElement {
  ...
  static createProperty(s, t = Hi) {
    if (t.state && (t.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(s) && ((t = Object.create(t)).wrapped = !0), this.elementProperties.set(s, t), !t.noAccessor) {
      ...
      i !== void 0 && gr(this.prototype, s, i);
    }
  }
  static getPropertyDescriptor(s, t, e) {
    const { get: i, set: M } = jr(this.prototype, s) ?? { get() {
      return this[t];
    }, set(n) {
      this[t] = n;
    } };
  ...
  static getPropertyOptions(s) {
    return this.elementProperties.get(s) ?? Hi;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Yt("properties"))) {
      const t = this.properties, e = [...Cr(t), ...Or(t)];
  ...
  static finalizeStyles(s) {
    ...
    if (Array.isArray(s)) {
      ...
      for (const i of e) t.unshift(Pi(i));
    } else s !== void 0 && t.push(Pi(s));
    return t;
  }
  static _$Eu(s, t) {
    const e = t.attribute;
  ...
  createRenderRoot() {
    ...
    return Xr(s, this.constructor.elementStyles), s;
  }
  connectedCallback() {
    var s;
  ...
  _$ET(s, t) {
    ...
    if (i !== void 0 && e.reflect === !0) {
      const n = (((M = e.converter) == null ? void 0 : M.toAttribute) !== void 0 ? e.converter : be).toAttribute(t, e.type);
  ...
  requestUpdate(s, t, e, i = !1, M) {
    ...
    if (s !== void 0) {
      ...
      if (i === !1 && (M = this[s]), e ?? (e = L.getPropertyOptions(s)), !((e.hasChanged ?? Di)(M, t) || e.useDefault && e.reflect && M === ((n = this._$Ej) == null ? void 0 : n.get(s)) && !this.hasAttribute(L._$Eu(s, e)))) return;
      this.C(s, t, e);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jt = globalThis, qi = /* @__PURE__ */ a((r) => r, "i$1"), ue = Jt.trustedTypes, Ki = ue ? ue.createPolicy("lit-html", { createHTML: /* @__PURE__ */ a((r) => r, "createHTML") }) : void 0, $M = "$lit$", Os = `lit$${Math.random().toFixed(9).slice(2)}$`, ZM = "?" + Os, vr = `<${ZM}>`, Js = document, Rt = /* @__PURE__ */ a(() => Js.createComment(""), "c"), Bt = /* @__PURE__ */ a((r) => r === null || typeof r != "object" && typeof r != "function", "a"), pi = Array.isArray, _r = /* @__PURE__ */ a((r) => pi(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", "d"), Oe = `[ 	
\f\r]`, mt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, sM = /-->/g, tM = />/g, As = RegExp(`>|${Oe}(?:([^\\s"'>=/]+)(${Oe}*=${Oe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), eM = /'/g, iM = /"/g, PM = /^(?:script|style|textarea|title)$/i, GM = /* @__PURE__ */ a((r) => (s, ...t) => ({ _$litType$: r, strings: s, values: t }), "x"), z = GM(1), MM = GM(2), ht = Symbol.for("lit-noChange"), D = Symbol.for("lit-nothing"), rM = /* @__PURE__ */ new WeakMap(), Qs = Js.createTreeWalker(Js, 129);
function HM(r, s) {
  if (!pi(r) || !r.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return Ki !== void 0 ? Ki.createHTML(s) : s;
}
a(HM, "V");
const Ur = /* @__PURE__ */ a((r, s) => {
  const t = r.length - 1, e = [];
  let i, M = s === 2 ? "<svg>" : s === 3 ? "<math>" : "", n = mt;
  for (let L = 0; L < t; L++) {
    const c = r[L];
    let l, o, d = -1, N = 0;
    for (; N < c.length && (n.lastIndex = N, o = n.exec(c), o !== null); ) N = n.lastIndex, n === mt ? o[1] === "!--" ? n = sM : o[1] !== void 0 ? n = tM : o[2] !== void 0 ? (PM.test(o[2]) && (i = RegExp("</" + o[2], "g")), n = As) : o[3] !== void 0 && (n = As) : n === As ? o[0] === ">" ? (n = i ?? mt, d = -1) : o[1] === void 0 ? d = -2 : (d = n.lastIndex - o[2].length, l = o[1], n = o[3] === void 0 ? As : o[3] === '"' ? iM : eM) : n === iM || n === eM ? n = As : n === sM || n === tM ? n = mt : (n = As, i = void 0);
    const T = n === As && r[L + 1].startsWith("/>") ? " " : "";
    M += n === mt ? c + vr : d >= 0 ? (e.push(l), c.slice(0, d) + $M + c.slice(d) + Os + T) : c + Os + (d === -2 ? L : T);
  }
  return [HM(r, M + (r[t] || "<?>") + (s === 2 ? "</svg>" : s === 3 ? "</math>" : "")), e];
}, "N"), ge = class ge {
  constructor({ strings: s, _$litType$: t }, e) {
    ...
    for (; (i = Qs.nextNode()) !== null && c.length < L; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const d of i.getAttributeNames()) if (d.endsWith($M)) {
      ...
      } else if (i.nodeType === 8) if (i.data === ZM) c.push({ type: 2, index: M });
      else {
        let d = -1;
...
const je = class je {
  ...
  _$AI(s, t = this) {
    s = Ft(this, s, t), Bt(s) ? s === D || s == null || s === "" ? (this._$AH !== D && this._$AR(), this._$AH = D) : s !== this._$AH && s !== ht && this._(s) : s._$litType$ !== void 0 ? this.$(s) : s.nodeType !== void 0 ? this.T(s) : _r(s) ? this.k(s) : this._(s);
  }
  O(s) {
  ...
  $(s) {
    var M;
    const { values: t, _$litType$: e } = s, i = typeof e == "number" ? this._$AC(s) : (e.el === void 0 && (e.el = $t.createElement(HM(e.h, e.h[0]), this.options)), e);
  ...
  _$AC(s) {
    let t = rM.get(s.strings);
    return t === void 0 && rM.set(s.strings, t = new $t(s)), t;
  }
  k(s) {
    pi(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let e, i = 0;
    for (const M of s) i === t.length ? t.push(e = new je(this.O(Rt()), this.O(Rt()), this, this.options)) : e = t[i], e._$AI(M), i++;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ys = globalThis, Ai = class Ai extends st {
  constructor() {
  ...
  update(s) {
    const t = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(s), this._$Do = Vr(t, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var s;
...
let k = Ai;
var JM;
k._$litElement$ = !0, k.finalized = !0, (JM = Ys.litElementHydrateSupport) == null || JM.call(Ys, { LitElement: k });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ar = { attribute: !0, type: String, converter: be, reflect: !1, hasChanged: Di }, Qr = /* @__PURE__ */ a((r = Ar, s, t) => {
...
function y(r) {
  return (s, t) => typeof t == "object" ? Qr(r, s, t) : ((e, i, M) => {
...
function Wi() {
  ...
  return Jr() ? { baseUrl: "", endpoints: r } : Rr() ? { baseUrl: ve.baseUrl, endpoints: r } : {
...
a(ne, "loadFromStorage");
const Zr = {
  user: null,
  isAuthenticated: !1,
  isLoading: !0
};
let pt = { ...Zr }, Ks = null, Le = null, qM = "";
...
async function KM() {
  if (Ks !== null)
    return Ks;
  try {
    const r = await fetch(`${qM}/api/auth/me`, {
      credentials: "include"
    });
...
async function qr(r) {
  try {
    ...
    const t = await s.json();
    return ks({ user: t.user, isAuthenticated: !0, isLoading: !1 }), await sr(), { success: !0 };
  } catch {
...
a(ae, "isAuthenticated");
const _e = "gw-migrated";
async function sr() {
  if (localStorage.getItem(_e))
    return;
  const r = ne(re.SOURCES, []), s = ne(re.CONNECTIONS, []), t = ne(re.FAVORITES, []), e = ne(re.DASHBOARDS, []);
...
a(sr, "autoMigrateIfNeeded");
const aM = /\/api\/explore\/v2\.1\/catalog\/datasets\/([^/]+)/, tr = {
  id: "opendatasoft",
...
}, oM = /tabular-api\.data\.gouv\.fr\/api\/resources\/([^/]+)/, er = {
  id: "tabular",
...
a(se, "registerProvider");
se(tr);
se(er);
se(ir);
se(rr);
se(Mr);
const cM = `${Ii}/beacon`, NM = /* @__PURE__ */ new Set();
function us(r, s) {
  const t = `${r}:${s || ""}`;
  if (NM.has(t) || (NM.add(t), typeof window > "u"))
    return;
  const e = window.location.hostname;
  if (e === "localhost" || e === "127.0.0.1" || e === new URL(Ii).hostname)
    return;
  ...
  if (i.set("c", r), s && i.set("t", s), i.set("r", window.location.origin), typeof window < "u" && window.__gwDbMode === !0)
    try {
      fetch("/api/monitoring/beacon", {
        ...
        new Image().src = `${cM}?${i.toString()}`;
      });
      return;
    } catch {
    }
  const n = `${cM}?${i.toString()}`;
  try {
    new Image().src = n;
  } catch {
  }
...
a(Ue, "buildFetchOptions$3");
const oe = 100, Ve = 10, ki = class ki {
  constructor() {
...
a(ki, "OpenDataSoftAdapter");
let ei = ki;
function TM(r, s) {
  const t = {};
  return s && (t.signal = s), r.headers && Object.keys(r.headers).length > 0 && (t.headers = r.headers), t;
}
a(TM, "buildFetchOptions$2");
const le = 50, Ae = 500, Yi = class Yi {
  constructor() {
  ...
  async fetchAll(s, t) {
    var l;
    const e = s.limit <= 0, i = e ? Ae * le : s.limit;
    let M = [], n = -1, L = 1;
    for (let o = 0; o < Ae && !(i - M.length <= 0); o++) {
      const N = this.buildUrl(s, le, L), T = await fetch(N, TM(s, t));
      if (!T.ok)
      ...
      if (!w || n >= 0 && M.length >= n || u.length < le)
        break;
    }
  ...
  async fetchPage(s, t, e) {
    var l;
    const i = this.buildServerSideUrl(s, t), M = await fetch(i, TM(s, e));
    if (!M.ok)
      throw new Error(`HTTP ${M.status}: ${M.statusText}`);
...
a(Ji, "GristAdapter");
let Mi = Ji;
const yM = "https://api.insee.fr/melodi", xM = 1e3, Qe = 100;
function zM(r, s) {
  const t = {};
  return s && (t.signal = s), r.headers && Object.keys(r.headers).length > 0 && (t.headers = r.headers), t;
}
a(zM, "buildFetchOptions");
const Ri = class Ri {
  constructor() {
  ...
  async fetchAll(s, t) {
    var c;
    const e = s.pageSize > 0 ? s.pageSize : xM, M = s.limit <= 0 ? Qe * e : s.limit;
    let n = [], L = -1;
    for (let l = 1; l <= Qe; l++) {
      const o = M - n.length;
      if (o <= 0)
        break;
      const d = Math.min(e, o), N = this.buildUrl(s, d, l), T = await fetch(N, zM(s, t));
      if (!T.ok)
        throw new Error(`HTTP ${T.status}: ${T.statusText}`);
   ...
   */
  buildUrl(s, t, e) {
    const i = s.baseUrl || yM, M = new URL(`${i}/data/${s.datasetId}`), n = t ?? (s.limit > 0 ? s.limit : xM);
   ...
   */
  buildServerSideUrl(s, t) {
    const e = s.baseUrl || yM, i = new URL(`${e}/data/${s.datasetId}`);
...
a(ji, "subscribeToSourceCommands");
function ee(r, s) {
...
let _ = (rt = class extends k {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), this._cleanup(), this.id && (te(this.id), gi(this.id));
  }
  updated(s) {
  ...
  getAdapter() {
    return this._isAdapterMode() ? (this._adapter || (this._adapter = Mn(this.apiType)), this._adapter) : null;
  }
  ...
  _setupCommandListener() {
    this._unsubscribeCommands && (this._unsubscribeCommands(), this._unsubscribeCommands = null), !(!this.id || !(this.paginate || this.serverSide || this._isAdapterMode())) && (this._unsubscribeCommands = ji(this.id, (t) => {
      let e = !1;
  ...
  async _fetchViaUrl() {
    if (this.url) {
      ...
      try {
        const s = this._buildUrl();
        let t = Br(s);
        const e = this._buildFetchOptions();
        if (this.useProxy && t === s) {
          const n = $r(t, e.headers);
          t = n.url, e.headers = n.headers;
        }
        ...
        this.paginate && M.meta && It(this.id, {
          page: M.meta.page ?? this._currentPage,
          pageSize: M.meta.page_size ?? this.pageSize,
          total: M.meta.total ?? 0
        }), this.transform ? this._data = $(M, this.transform) : this.paginate && M.data && !this.transform ? this._data = M.data : this._data = M, Ns(this.id, this._data), this.cacheTtl > 0 && ae() && this._putCache(this._data).catch(() => {
        });
      } catch (s) {
        if (s.name === "AbortError")
          return;
        if (this.cacheTtl > 0 && ae()) {
  ...
  async _fetchViaAdapter() {
    ...
    try {
      ...
      this._data = i.data, Ns(this.id, this._data), this.cacheTtl > 0 && ae() && this._putCache(this._data).catch(() => {
      });
    } catch (i) {
...
let ss = (nt = class extends k {
  ...
  _subscribeToSourceData(s) {
    const t = Rs(s);
    t !== void 0 && (this._rawData = Array.isArray(t) ? t : [t], this._handleSourceData()), this._unsubscribe = ee(s, {
  ...
  _applyGroupByAndAggregate(s) {
    ...
    for (const [n, L] of i) {
      ...
      for (const o of e) {
        ...
        nM(c, d, this._computeAggregate(L, o));
      }
      M.push(c);
    }
    return M;
  ...
  _setupCommandForwarding() {
    this._unsubscribeCommands && (this._unsubscribeCommands(), this._unsubscribeCommands = null), !(!this.id || !this.serverSide) && this.source && (this._unsubscribeCommands = ji(this.id, (s) => {
      gs(this.source, s);
    }));
  }
  // --- Public API ---
...
let zs = (Lt = class extends k {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), this._unsubscribe && (this._unsubscribe(), this._unsubscribe = null), this._unsubscribePageRequests && (this._unsubscribePageRequests(), this._unsubscribePageRequests = null), this.id && (te(this.id), gi(this.id));
  }
  updated(s) {
  ...
  _initialize() {
    ...
    const s = Rs(this.source);
    s !== void 0 && this._processData(s), this._unsubscribe = ee(this.source, {
    ...
    }), this._unsubscribePageRequests = ji(this.id, (t) => {
      gs(this.source, t);
    });
  }
  _processData(s) {
...
let Q = (at = class extends k {
  ...
  _initialize() {
    ...
    t !== void 0 && this._onData(t), this._unsubscribe = ee(this.source, {
      onLoaded: /* @__PURE__ */ a((e) => {
        this._onData(e);
      }, "onLoaded"),
      onLoading: /* @__PURE__ */ a(() => {
...
let G = (ot = class extends k {
  ...
  _initialize() {
    ...
    const s = Rs(this.source);
    s !== void 0 && this._onData(s), this._unsubscribe = ee(this.source, {
      onLoaded: /* @__PURE__ */ a((e) => {
        this._onData(e);
      }, "onLoaded"),
      onLoading: /* @__PURE__ */ a(() => {
  ...
  const t = class t extends r {
    ...
    _subscribeToSource() {
      ...
      if (!i)
        return;
      const M = Rs(i);
      M !== void 0 && (this._sourceData = M, this.onSourceData(M)), this._unsubscribeSource = ee(i, {
...
let os = (lt = class extends jt(k) {
  ...
  _computeValue() {
    return !this._sourceData || !this.valeur ? null : uM(this._sourceData, this.valeur);
  }
  _getColor() {
    if (this.couleur)
      return this.couleur;
    const s = this._computeValue();
    return typeof s != "number" ? "bleu" : on(s, this.seuilVert, this.seuilOrange);
  }
  _getTendanceInfo() {
    if (!this.tendance || !this._sourceData)
      return null;
    const s = uM(this._sourceData, this.tendance);
  ...
  _getAriaLabel() {
    ...
    const s = this._computeValue(), t = wM(s, this.format);
    let e = `${this.label}: ${t}`;
  ...
  render() {
    const s = this._computeValue(), t = wM(s, this.format), e = SM[this._getColor()] || SM.bleu, i = this._getTendanceInfo();
    return z`
      <div
        class="gouv-kpi ${e}"
        role="figure"
...
let Y = (Nt = class extends jt(k) {
  ...
  _processMapData() {
    ...
    for (const e of this._data) {
      ...
      (this.type === "map" ? Yr(i) : i !== "") && (t[i] = Math.round(M * 100) / 100);
    }
...
a(cn, "flatten");
function Lr(r) {
  return Array.from(cn(r));
}
a(Lr, "merge");
var v = 1e-6, j = Math.PI, ys = j / 2, hM = j / 4, ws = j * 2, Ws = 180 / j, as = j / 180, A = Math.abs, Nn = Math.atan, Pt = Math.atan2, Z = Math.cos, P = Math.sin, Tn = Math.sign || function(r) {
...
a(xs, "noop");
function Se(r, s) {
  r && DM.hasOwnProperty(r.type) && DM[r.type](r, s);
}
a(Se, "streamGeometry");
var FM = {
  ...
  LineString: /* @__PURE__ */ a(function(r, s) {
    ni(r.coordinates, s, 0);
  }, "LineString"),
  MultiLineString: /* @__PURE__ */ a(function(r, s) {
    for (var t = r.coordinates, e = -1, i = t.length; ++e < i; ) ni(t[e], s, 0);
  }, "MultiLineString"),
  Polygon: /* @__PURE__ */ a(function(r, s) {
    pM(r.coordinates, s);
  }, "Polygon"),
  MultiPolygon: /* @__PURE__ */ a(function(r, s) {
    for (var t = r.coordinates, e = -1, i = t.length; ++e < i; ) pM(t[e], s);
  }, "MultiPolygon"),
...
function pM(r, s) {
  var t = -1, e = r.length;
  for (s.polygonStart(); ++t < e; ) ni(r[t], s, 1);
  s.polygonEnd();
}
a(pM, "streamPolygon");
function tt(r, s) {
  r && FM.hasOwnProperty(r.type) ? FM[r.type](r, s) : Se(r, s);
}
a(tt, "geoStream");
function Li(r) {
...
a(ai, "cartesianNormalizeInPlace");
function oi(r, s) {
  function t(e, i) {
...
li.invert = li;
function xn(r, s, t) {
  return (r %= ws) ? s || t ? oi(WM(r), XM(s, t)) : WM(r) : s || t ? XM(s, t) : li;
}
a(xn, "rotateRadians");
function IM(r) {
  return function(s, t) {
...
a(IM, "forwardRotationLambda");
function WM(r) {
  var s = IM(r);
  return s.invert = IM(-r), s;
}
a(WM, "rotationLambda");
function XM(r, s) {
...
a(XM, "rotationPhiGamma");
function zn(r, s, t, e, i, M) {
  if (t) {
    var n = Z(s), L = P(s), c = e * t;
    i == null ? (i = s + e * ws, M = s - c / 2) : (i = fM(n, i), M = fM(n, M), (e > 0 ? i < M : i > M) && (i += e * ws));
...
function or(r, s, t, e, i) {
  ...
  if (r.forEach(function(x) {
    ...
    for (n.sort(s), gM(M), gM(n), L = 0, c = n.length; L < c; ++L)
      n[L].e = t = !t;
    for (var l = M[0], o, d; ; ) {
...
a(gM, "link");
function Ye(r) {
  return A(r[0]) <= j ? r[0] : Tn(r[0]) * ((A(r[0]) + j) % ws - j);
}
a(Ye, "longitude");
function wn(r, s) {
  ...
  for (var l = 0, o = r.length; l < o; ++l)
    if (N = (d = r[l]).length)
      for (var d, N, T = d[N - 1], x = Ye(T), u = T[1] / 2 + hM, w = P(u), X = Z(u), h = 0; h < N; ++h, x = S, w = f, X = E, T = I) {
        var I = d[h], S = Ye(I), W = I[1] / 2 + hM, f = P(W), E = Z(W), C = S - x, O = C >= 0 ? 1 : -1, V = O * C, p = V > j, ns = w * f;
        if (c.add(Pt(ns * O * P(V), X * E + ns * Z(V))), n += p ? C + O * ws : C, p ^ x >= t ^ S >= t) {
          var B = he(Xt(T), Xt(I));
          ai(B);
          var m = he(M, B);
          ai(m);
          var b = (p ^ C >= 0 ? -1 : 1) * Gt(m[2]);
          (e > b || e === b && (B[0] || B[1])) && (L += p ^ C >= 0 ? 1 : -1);
        }
      }
  return (n < -v || n < v && c < -1e-12) ^ L & 1;
}
a(wn, "polygonContains");
function lr(r, s, t, e) {
  return function(i) {
    var M = s(i), n = ar(), L = s(n), c = !1, l, o, d, N = {
      ...
      polygonStart: /* @__PURE__ */ a(function() {
        N.point = X, N.lineStart = h, N.lineEnd = I, o = [], l = [];
      }, "polygonStart"),
      polygonEnd: /* @__PURE__ */ a(function() {
        N.point = T, N.lineStart = u, N.lineEnd = w, o = Lr(o);
        var S = wn(l, e);
        o.length ? (c || (i.polygonStart(), c = !0), or(o, un, S, t, i)) : S && (c || (i.polygonStart(), c = !0), i.lineStart(), t(null, null, 1, i), i.lineEnd()), c && (i.polygonEnd(), c = !1), o = l = null;
      }, "polygonEnd"),
    ...
    function I() {
      ...
      if (d.pop(), l.push(d), d = null, !!E) {
        ...
        E > 1 && S & 2 && W.push(W.pop().concat(W.shift())), o.push(W.filter(bn));
      }
    }
...
function Sn(r) {
  ...
  return {
    ...
    point: /* @__PURE__ */ a(function(M, n) {
      ...
      A(c - j) < v ? (r.point(s, t = (t + n) / 2 > 0 ? ys : -ys), r.point(e, t), r.lineEnd(), r.lineStart(), r.point(L, t), r.point(M, t), i = 0) : e !== L && c >= j && (A(s - e) < v && (s -= e * v), A(M - L) < v && (M -= L * v), t = hn(s, t, M, n), r.point(e, t), r.lineEnd(), r.lineStart(), r.point(L, t), i = 0), r.point(s = M, t = n), e = L;
    }, "point"),
...
a(Sn, "clipAntimeridianLine");
function hn(r, s, t, e) {
  var i, M, n = P(r - t);
  return A(n) > v ? Nn((P(s) * (M = Z(e)) * P(t) - P(e) * (i = Z(s)) * P(r)) / (i * M * n)) : (s + e) / 2;
}
a(hn, "clipAntimeridianIntersect");
function Fn(r, s, t, e) {
  var i;
  if (r == null)
...
a(Fn, "clipAntimeridianInterpolate");
function Dn(r) {
...
function In(r, s, t, e) {
  ...
  return a(c, "comparePoint"), function(l) {
    ...
    a(C, "point");
    function O() {
      for (var b = 0, g = 0, K = T.length; g < K; ++g)
        for (var Ls = T[g], ds = 1, Et = Ls.length, ps = Ls[0], Vs, Is, Me = ps[0], qs = ps[1]; ds < Et; ++ds)
          Vs = Me, Is = qs, ps = Ls[ds], Me = ps[0], qs = ps[1], Is <= e ? qs > e && (Me - Vs) * (e - Is) > (qs - Is) * (r - Vs) && ++b : qs <= e && (Me - Vs) * (e - Is) < (qs - Is) * (r - Vs) && --b;
      return b;
    }
    a(O, "polygonInside");
    function V() {
    ...
    a(V, "polygonStart");
    function p() {
      var b = O(), g = f && b, K = (N = Lr(N)).length;
      (g || K) && (l.polygonStart(), g && (l.lineStart(), M(null, null, 1, l), l.lineEnd()), K && or(N, L, b, M, l), l.polygonEnd()), o = l, N = T = x = null;
    }
    a(p, "polygonEnd");
    function ns() {
    ...
    function m(b, g) {
      var K = i(b, g);
      if (T && x.push([b, g]), W)
        u = b, w = g, X = K, W = !1, K && (o.lineStart(), o.point(b, g));
      else if (K && S) o.point(b, g);
      else {
        var Ls = [h = Math.max(Te, Math.min(Ut, h)), I = Math.max(Te, Math.min(Ut, I))], ds = [b = Math.max(Te, Math.min(Ut, b)), g = Math.max(Te, Math.min(Ut, g))];
        pn(Ls, ds, r, s, t, e) ? (S || (o.lineStart(), o.point(Ls[0], Ls[1])), o.point(ds[0], ds[1]), K || o.lineEnd(), f = !1) : K && (o.lineStart(), o.point(b, g), f = !1);
      }
      h = b, I = g, S = K;
    }
...
var Je = new js(), ci = new js(), dr, cr, Ni, Ti, Xs = {
  point: xs,
  lineStart: xs,
  lineEnd: xs,
  polygonStart: /* @__PURE__ */ a(function() {
    Xs.lineStart = Wn, Xs.lineEnd = fn;
  }, "polygonStart"),
  polygonEnd: /* @__PURE__ */ a(function() {
    Xs.lineStart = Xs.lineEnd = Xs.point = xs, Je.add(A(ci)), ci = new js();
  }, "polygonEnd"),
  result: /* @__PURE__ */ a(function() {
    var r = Je / 2;
    return Je = new js(), r;
...
a(Wn, "areaRingStart");
function Xn(r, s) {
  Xs.point = Nr, dr = Ni = r, cr = Ti = s;
}
a(Xn, "areaPointFirst");
function Nr(r, s) {
  ci.add(Ti * r - Ni * s), Ni = r, Ti = s;
}
a(Nr, "areaPoint");
function fn() {
  Nr(dr, cr);
...
a(fn, "areaRingEnd");
var ft = 1 / 0, Fe = ft, Ht = -ft, De = Ht, pe = {
  point: gn,
  lineStart: xs,
  lineEnd: xs,
  polygonStart: xs,
...
var yi = 0, xi = 0, Vt = 0, Ie = 0, We = 0, et = 0, zi = 0, wi = 0, At = 0, Tr, yr, Fs, Ds, Ts = {
  ...
  lineEnd: OM,
  polygonStart: /* @__PURE__ */ a(function() {
    Ts.lineStart = On, Ts.lineEnd = En;
  }, "polygonStart"),
  polygonEnd: /* @__PURE__ */ a(function() {
    Ts.point = Bs, Ts.lineStart = CM, Ts.lineEnd = OM;
  }, "polygonEnd"),
  result: /* @__PURE__ */ a(function() {
    var r = At ? [zi / At, wi / At] : et ? [Ie / et, We / et] : Vt ? [yi / Vt, xi / Vt] : [NaN, NaN];
    return yi = xi = Vt = Ie = We = et = zi = wi = At = 0, r;
  }, "result")
};
function Bs(r, s) {
  yi += r, xi += s, ++Vt;
...
a(CM, "centroidLineStart");
function jn(r, s) {
  Ts.point = Cn, Bs(Fs = r, Ds = s);
}
a(jn, "centroidPointFirstLine");
function Cn(r, s) {
  var t = r - Fs, e = s - Ds, i = Ps(t * t + e * e);
  Ie += i * (Fs + r) / 2, We += i * (Ds + s) / 2, et += i, Bs(Fs = r, Ds = s);
}
a(Cn, "centroidPointLine");
function OM() {
  Ts.point = Bs;
}
a(OM, "centroidLineEnd");
function On() {
  Ts.point = mn;
}
a(On, "centroidRingStart");
function En() {
  xr(Tr, yr);
}
a(En, "centroidRingEnd");
function mn(r, s) {
  Ts.point = xr, Bs(Tr = Fs = r, yr = Ds = s);
}
a(mn, "centroidPointFirstRing");
function xr(r, s) {
  var t = r - Fs, e = s - Ds, i = Ps(t * t + e * e);
...
var bi = new js(), Re, wr, br, Qt, kt, qt = {
  point: xs,
  lineStart: /* @__PURE__ */ a(function() {
    qt.point = vn;
  }, "lineStart"),
  lineEnd: /* @__PURE__ */ a(function() {
    Re && ur(wr, br), qt.point = xs;
  }, "lineEnd"),
  polygonStart: /* @__PURE__ */ a(function() {
    Re = !0;
  }, "polygonStart"),
...
function vn(r, s) {
  qt.point = ur, wr = Qt = r, br = kt = s;
}
a(vn, "lengthPointFirst");
function ur(r, s) {
  Qt -= r, kt -= s, bi.add(Ps(Qt * Qt + kt * kt)), Qt = r, kt = s;
}
a(ur, "lengthPoint");
let EM, Xe, mM, vM;
const $i = class $i {
  constructor(s) {
    this._append = s == null ? Sr : _n(s), this._radius = 4.5, this._ = "";
  }
  pointRadius(s) {
  ...
  point(s, t) {
    switch (this._point) {
      ...
      default: {
        if (this._append`M${s},${t}`, this._radius !== mM || this._append !== Xe) {
          const e = this._radius, i = this._;
          this._ = "", this._append`m0,${e}a${e},${e} 0 1,1 0,${-2 * e}a${e},${e} 0 1,1 0,${2 * e}z`, mM = e, Xe = this._append, vM = this._, this._ = i;
        }
        this._ += vM;
        break;
      }
...
function Un(r, s) {
  ...
  return a(n, "path"), n.area = function(L) {
    ...
    return arguments.length ? (M = L == null ? (s = null, new fe(t)) : new zr(s = L), typeof e != "function" && M.pointRadius(e), n) : s;
...
a(Qn, "fitHeight");
var _M = 16, kn = Z(30 * as);
function UM(r, s) {
  return +s ? Jn(r, s) : Yn(r);
}
a(UM, "resample");
function Yn(r) {
  return Ci({
...
function Jn(r, s) {
  function t(e, i, M, n, L, c, l, o, d, N, T, x, u, w) {
    ...
    if (I > 4 * s && u--) {
      ...
      (b * b / I > s || A((X * B + h * m) / I - 0.5) > 0.3 || n * N + L * T + c * x < kn) && (t(e, i, M, n, L, c, p, ns, O, S /= E, W /= E, f, u, w), w.point(p, ns), t(p, ns, O, S, W, f, l, o, d, N, T, x, u, w));
    }
  }
  return a(t, "resampleLineTo"), function(e) {
    ...
    function I(C, O) {
      ...
      t(d, N, o, T, x, u, d = p[0], N = p[1], o = C, T = V[0], x = V[1], u = V[2], _M, e), e.point(d, N);
    }
    a(I, "linePoint");
    function S() {
      w.point = X, e.lineEnd();
    ...
    a(f, "ringPoint");
    function E() {
      t(d, N, o, T, x, u, M, n, i, L, c, l, _M, e), w.lineEnd = S, S();
    }
...
a(Bn, "transformRotate");
function $n(r, s, t, e, i) {
  function M(n, L) {
...
a($n, "scaleTranslate");
function VM(r, s, t, e, i, M) {
  if (!M) return $n(r, s, t, e, i);
...
a(Zn, "projection");
function Pn(r) {
  var s, t = 150, e = 480, i = 250, M = 0, n = 0, L = 0, c = 0, l = 0, o, d = 0, N = 1, T = 1, x = null, u = jM, w = null, X, h, I, S = di, W = 0.5, f, E, C, O, V;
  function p(b) {
    return C(b[0] * as, b[1] * as);
  }
  a(p, "projection");
  function ns(b) {
    return b = C.invert(b[0], b[1]), b && [b[0] * Ws, b[1] * Ws];
  }
  a(ns, "invert"), p.stream = function(b) {
    return O && V === b ? O : O = Rn(Bn(o)(u(f(S(V = b)))));
  }, p.preclip = function(b) {
    return arguments.length ? (u = b, x = void 0, m()) : u;
  }, p.postclip = function(b) {
    return arguments.length ? (S = b, w = X = h = I = null, m()) : S;
  }, p.clipAngle = function(b) {
    return arguments.length ? (u = +b ? Dn(x = b * as) : (x = null, jM), m()) : x * Ws;
  }, p.clipExtent = function(b) {
    return arguments.length ? (S = b == null ? (w = X = h = I = null, di) : In(w = +b[0][0], X = +b[0][1], h = +b[1][0], I = +b[1][1]), m()) : w == null ? null : [[w, X], [h, I]];
  }, p.scale = function(b) {
    ...
    return arguments.length ? (f = UM(E, W = b * b), m()) : Ps(W);
  }, p.fitExtent = function(b, g) {
    return hr(p, b, g);
  }, p.fitSize = function(b, g) {
    return Vn(p, b, g);
  }, p.fitWidth = function(b, g) {
    return An(p, b, g);
  }, p.fitHeight = function(b, g) {
    return Qn(p, b, g);
  };
  function B() {
    var b = VM(t, 0, 0, N, T, d).apply(null, s(M, n)), g = VM(t, e - b[0], i - b[1], N, T, d);
    return o = xn(L, c, l), E = oi(s, g), C = oi(o, E), f = UM(E, W), m();
  }
  a(B, "recenter");
  function m() {
    return O = V = null, p;
...
a(Fr, "naturalEarth1Raw");
Fr.invert = function(r, s) {
  var t = s, e = 25, i;
  do {
    var M = t * t, n = M * M;
...
function Gn() {
  return Zn(Fr).scale(175.295);
}
a(Gn, "geoNaturalEarth1");
function Hn(r) {
  return r;
}
a(Hn, "identity");
...
a(s0, "feature");
function AM(r, s) {
  var t = s.id, e = s.bbox, i = s.properties == null ? {} : s.properties, M = Dr(r, s);
...
a(t0, "stitch");
function e0(r) {
  return Dr(r, i0.apply(this, arguments));
}
a(e0, "mesh");
function i0(r, s, t) {
  var e, i, M;
  if (arguments.length > 1) e = M0(r, s, t);
  else for (i = 0, e = new Array(M = r.arcs.length); i < M; ++i) e[i] = i;
  return { type: "MultiLineString", arcs: t0(r, e) };
}
a(i0, "meshArcs");
function M0(r, s, t) {
  var e = [], i = [], M;
...
async function o0() {
  ...
  return ye = await (await fetch(r)).json(), ye;
}
a(o0, "loadTopology");
const Be = 960, $e = 500, xe = 20, kM = {
  sequentialAscending: [
    "#F5F5FE",
    "#E3E3FD",
    "#C1C1FB",
...
let is = (Tt = class extends jt(k) {
  ...
  async _loadMap() {
    try {
      this._topology = await o0(), this.requestUpdate();
    } catch (s) {
  ...
  _getChoroplethPalette() {
    return kM[this.selectedPalette] || kM.sequentialAscending;
  }
  _getColorScale(s) {
    if (s.length === 0)
      return () => "#E5E5F4";
  ...
  _getFeatures() {
    ...
    return s0(this._topology, s).features;
  }
  _getBorders() {
    if (!this._topology)
      return null;
    const s = this._topology.objects.countries;
    return e0(this._topology, s, (t, e) => t !== e);
  }
  _getProjection() {
    const s = Gn().translate([Be / 2, $e / 2]).scale(153);
    if (this._zoomedContinent) {
      const t = this._getFeatures().filter((e) => QM[e.id] === this._zoomedContinent);
      if (t.length > 0) {
        const e = { type: "FeatureCollection", features: t };
        s.fitExtent([[xe, xe], [Be - xe, $e - xe]], e);
      }
    }
    return s;
  }
  ...
  // --- Render ---
  _renderMap() {
    const s = this._getFeatures(), t = this._getBorders(), e = this._getProjection(), i = Un(e), M = this._buildValueMap(), n = [...M.values()], L = this._getColorScale(n), c = "#F0F0F0", l = s.map((d) => {
      ...
      <div class="gouv-world-map__container" style="position: relative;">
        ${this._zoomedContinent ? z`
          <button
            ...
            ${YM[this._zoomedContinent] || this._zoomedContinent}
          </button>
        ` : D}
  ...
  _renderTooltip(s) {
    ...
    if (!this._hoveredCountryId)
      return D;
    const t = a0[this._hoveredCountryId] || ((n = (M = this._getFeatures().find((L) => L.id === this._hoveredCountryId)) == null ? void 0 : M.properties) == null ? void 0 : n.name) || this._hoveredCountryId, e = s.get(this._hoveredCountryId), i = e !== void 0 ? `${e.toLocaleString("fr-FR")}${this.unitTooltip ? " " + this.unitTooltip : ""}` : "Pas de donnees";
    return z`
  ...
  _getAriaLabel() {
    ...
    return `Carte ${this._zoomedContinent ? YM[this._zoomedContinent] || this._zoomedContinent : "monde"}, ${s} valeurs`;
  }
  render() {
    return this._sourceLoading ? z`
...
let vs = (yt = class extends jt(k) {
  ...
  _ensureId() {
    this.id || (this.id = `gouv-raw-data-${++l0}`);
  }
  _applyAria() {
...
let Cs = (xt = class extends k {
  ...
  async _handleSubmit(s) {
    ...
    try {
      if (this._tab === "login") {
        const t = await qr({ email: this._email, password: this._password });
        if (!t.success) {
...
let $s = (zt = class extends k {
  ...
  async _initAuth() {
    try {
      const s = await Gr();
      this._dbMode = await KM(), this._user = s.user, this._unsubAuth = tn((t) => {
        this._user = t.user;
      });
    } catch {
    }
  ...
  async _handleLogout() {
    await sn(), window.location.reload();
  }
  _getNavItems() {
    return [
...
var pr = function(r, s, t, e) {
  var i = arguments.length, M = i < 3 ? s : e === null ? e = Object.getOwnPropertyDescriptor(s, t) : e, n;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") M = Reflect.decorate(r, s, t, e);
  else for (var L = r.length - 1; L >= 0; L--) (n = r[L]) && (M = (i < 3 ? n(M) : i > 3 ? n(s, t, M) : n(s, t)) || M);
  return i > 3 && M && Object.defineProperty(s, t, M), M;
}, wt;
let Si = (wt = class extends k {
  constructor() {
...
function c0(r, s) {
  ...
  const e = [];
  for (const [i, M] of t)
    e.push({ label: i, value: N0(M, s) });
  return e;
}
a(c0, "aggregateByLabel");
function N0(r, s) {
  switch (s) {
    case "sum":
...
export {
  ...
  c0 as aggregateByLabel,
  uM as computeAggregation,
  fs as dispatchDataError,
  Ns as dispatchDataLoaded,
  ms as dispatchDataLoading,
  d0 as extractLabelValues,
  Ln as formatCurrency,
  b0 as formatDate,
  bM as formatNumber,
  nn as formatPercentage,
  wM as formatValue,
  Mn as getAdapter,
  $ as getByPath,
  z0 as getByPathOrDefault,
  Rs as getDataCache,
  x0 as hasPath,
  ln as parseExpression,
  u0 as processChartData,
  w0 as registerAdapter,
  T0 as sortByValue,
  ee as subscribeToSource
};
